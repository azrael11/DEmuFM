...
type
  Tfrm_info = class(TForm)
    ...
    procedure txt_info_closeMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
      X, Y: Single);
    procedure txt_info_closeMouseLeave(Sender: TObject);
    procedure txt_info_closeMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
      X, Y: Single);
  private
...
procedure Tfrm_info.txt_info_closeMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Single);
begin
  (Sender as TText).Scale.X := 1.1;
  (Sender as TText).Scale.Y := 1.1;
