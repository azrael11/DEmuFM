...
const
  ...
  folders: array [0 .. 5] of string = ('box_art' + PathDelim, 'snapshots' + PathDelim, 'video' + PathDelim,
    'manuals' + PathDelim, 'rom' + PathDelim, 'bezels' + PathDelim);
  paths: array [0 .. 14] of string = ('arcade' + PathDelim, 'spectrum' + PathDelim, 'amstrad' + PathDelim,
    'commodore64' + PathDelim, 'game_and_watch' + PathDelim, 'nes' + PathDelim, 'gameboy' + PathDelim,
    'gameboy_color' + PathDelim, 'colecovision' + PathDelim, 'chip8' + PathDelim, 'master_system' + PathDelim,
    'sg_1000' + PathDelim, 'game_gear' + PathDelim, 'super_cassette_vision' + PathDelim,
    'mega_drive' + PathDelim);
...
begin
  ...
  dm.tConfigsamples.value := dm.tConfigprj_path.value + 'media' + PathDelim + 'arcade' + PathDelim + 'samples'
    + PathDelim;
