...
type
  ...
  public
    ...
    procedure change_misc_calls(despues_instruccion: tdespues_instruccion;
      raised_z80: type_raised = nil; m1_raised: type_m1_raise = nil);
...
procedure cpu_z80.change_misc_calls(despues_instruccion: tdespues_instruccion;
  raised_z80: type_raised = nil; m1_raised: type_m1_raise = nil);
begin
...
{$A4..$A7:NOP*2}
    ...
    $AA:
      begin // ind añadido el 03-12-08 usado por CPC test
        temp := self.in_port(r.bc.w);
        r.wz := r.bc.w - 1;
        r.bc.h := r.bc.h - 1;
        self.putbyte(r.hl.w, temp);
    ...
    $B2:
      begin // inir añadido el 05-10-08, lo usa una rom de Coleco!
        temp := self.in_port(r.bc.w);
        r.wz := r.bc.w + 1;
        r.bc.h := r.bc.h - 1;
        self.putbyte(r.hl.w, temp);
    ...
    $B3:
      begin // otir añadido el dia 18-09-04
        temp := self.getbyte(r.hl.w);
        r.bc.h := r.bc.h - 1;
        r.wz := r.bc.w + 1;
        self.out_port(r.bc.w, self.getbyte(r.hl.w));
