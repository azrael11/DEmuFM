...
type
  ...
  private
    ...
    fore_mask_buf: array [0 .. $2F] of byte;
    // Foreground mask for sprite-graphics collisions and priorities
...
const
  c64_paleta: array [0 .. 15] of integer = ($000000, $FDFEFC, $BE1A24, $30E6C6, $B41AE2, $1FD21E,
    $211BAE, $DFF60A, $B84104, $6A3304, $FE4A57, $424540, $70746F, $59FE59, $5F53FE, $A4A7A2);
  ...
  COL38_XSTOP = $157;
  ExpTable: array [0 .. 255] of word = ($0000, $0003, $000C, $000F, $0030, $0033, $003C, $003F,
    $00C0, $00C3, $00CC, $00CF, $00F0, $00F3, $00FC, $00FF, $0300, $0303, $030C, $030F, $0330,
    $0333, $033C, $033F, $03C0, $03C3, $03CC, $03CF, $03F0, $03F3, $03FC, $03FF, $0C00, $0C03,
    $0C0C, $0C0F, $0C30, $0C33, $0C3C, $0C3F, $0CC0, $0CC3, $0CCC, $0CCF, $0CF0, $0CF3, $0CFC,
    $0CFF, $0F00, $0F03, $0F0C, $0F0F, $0F30, $0F33, $0F3C, $0F3F, $0FC0, $0FC3, $0FCC, $0FCF,
    $0FF0, $0FF3, $0FFC, $0FFF, $3000, $3003, $300C, $300F, $3030, $3033, $303C, $303F, $30C0,
    $30C3, $30CC, $30CF, $30F0, $30F3, $30FC, $30FF, $3300, $3303, $330C, $330F, $3330, $3333,
    $333C, $333F, $33C0, $33C3, $33CC, $33CF, $33F0, $33F3, $33FC, $33FF, $3C00, $3C03, $3C0C,
    $3C0F, $3C30, $3C33, $3C3C, $3C3F, $3CC0, $3CC3, $3CCC, $3CCF, $3CF0, $3CF3, $3CFC, $3CFF,
    $3F00, $3F03, $3F0C, $3F0F, $3F30, $3F33, $3F3C, $3F3F, $3FC0, $3FC3, $3FCC, $3FCF, $3FF0,
    $3FF3, $3FFC, $3FFF, $C000, $C003, $C00C, $C00F, $C030, $C033, $C03C, $C03F, $C0C0, $C0C3,
    $C0CC, $C0CF, $C0F0, $C0F3, $C0FC, $C0FF, $C300, $C303, $C30C, $C30F, $C330, $C333, $C33C,
    $C33F, $C3C0, $C3C3, $C3CC, $C3CF, $C3F0, $C3F3, $C3FC, $C3FF, $CC00, $CC03, $CC0C, $CC0F,
    $CC30, $CC33, $CC3C, $CC3F, $CCC0, $CCC3, $CCCC, $CCCF, $CCF0, $CCF3, $CCFC, $CCFF, $CF00,
    $CF03, $CF0C, $CF0F, $CF30, $CF33, $CF3C, $CF3F, $CFC0, $CFC3, $CFCC, $CFCF, $CFF0, $CFF3,
    $CFFC, $CFFF, $F000, $F003, $F00C, $F00F, $F030, $F033, $F03C, $F03F, $F0C0, $F0C3, $F0CC,
    $F0CF, $F0F0, $F0F3, $F0FC, $F0FF, $F300, $F303, $F30C, $F30F, $F330, $F333, $F33C, $F33F,
    $F3C0, $F3C3, $F3CC, $F3CF, $F3F0, $F3F3, $F3FC, $F3FF, $FC00, $FC03, $FC0C, $FC0F, $FC30,
    $FC33, $FC3C, $FC3F, $FCC0, $FCC3, $FCCC, $FCCF, $FCF0, $FCF3, $FCFC, $FCFF, $FF00, $FF03,
    $FF0C, $FF0F, $FF30, $FF33, $FF3C, $FF3F, $FFC0, $FFC3, $FFCC, $FFCF, $FFF0, $FFF3,
    $FFFC, $FFFF);
  MultiExpTable: array [0 .. 255] of word = ($0000, $0005, $000A, $000F, $0050, $0055, $005A, $005F,
    $00A0, $00A5, $00AA, $00AF, $00F0, $00F5, $00FA, $00FF, $0500, $0505, $050A, $050F, $0550,
    $0555, $055A, $055F, $05A0, $05A5, $05AA, $05AF, $05F0, $05F5, $05FA, $05FF, $0A00, $0A05,
    $0A0A, $0A0F, $0A50, $0A55, $0A5A, $0A5F, $0AA0, $0AA5, $0AAA, $0AAF, $0AF0, $0AF5, $0AFA,
    $0AFF, $0F00, $0F05, $0F0A, $0F0F, $0F50, $0F55, $0F5A, $0F5F, $0FA0, $0FA5, $0FAA, $0FAF,
    $0FF0, $0FF5, $0FFA, $0FFF, $5000, $5005, $500A, $500F, $5050, $5055, $505A, $505F, $50A0,
    $50A5, $50AA, $50AF, $50F0, $50F5, $50FA, $50FF, $5500, $5505, $550A, $550F, $5550, $5555,
    $555A, $555F, $55A0, $55A5, $55AA, $55AF, $55F0, $55F5, $55FA, $55FF, $5A00, $5A05, $5A0A,
    $5A0F, $5A50, $5A55, $5A5A, $5A5F, $5AA0, $5AA5, $5AAA, $5AAF, $5AF0, $5AF5, $5AFA, $5AFF,
    $5F00, $5F05, $5F0A, $5F0F, $5F50, $5F55, $5F5A, $5F5F, $5FA0, $5FA5, $5FAA, $5FAF, $5FF0,
    $5FF5, $5FFA, $5FFF, $A000, $A005, $A00A, $A00F, $A050, $A055, $A05A, $A05F, $A0A0, $A0A5,
    $A0AA, $A0AF, $A0F0, $A0F5, $A0FA, $A0FF, $A500, $A505, $A50A, $A50F, $A550, $A555, $A55A,
    $A55F, $A5A0, $A5A5, $A5AA, $A5AF, $A5F0, $A5F5, $A5FA, $A5FF, $AA00, $AA05, $AA0A, $AA0F,
    $AA50, $AA55, $AA5A, $AA5F, $AAA0, $AAA5, $AAAA, $AAAF, $AAF0, $AAF5, $AAFA, $AAFF, $AF00,
    $AF05, $AF0A, $AF0F, $AF50, $AF55, $AF5A, $AF5F, $AFA0, $AFA5, $AFAA, $AFAF, $AFF0, $AFF5,
    $AFFA, $AFFF, $F000, $F005, $F00A, $F00F, $F050, $F055, $F05A, $F05F, $F0A0, $F0A5, $F0AA,
    $F0AF, $F0F0, $F0F5, $F0FA, $F0FF, $F500, $F505, $F50A, $F50F, $F550, $F555, $F55A, $F55F,
    $F5A0, $F5A5, $F5AA, $F5AF, $F5F0, $F5F5, $F5FA, $F5FF, $FA00, $FA05, $FA0A, $FA0F, $FA50,
    $FA55, $FA5A, $FA5F, $FAA0, $FAA5, $FAAA, $FAAF, $FAF0, $FAF5, $FAFA, $FAFF, $FF00, $FF05,
    $FF0A, $FF0F, $FF50, $FF55, $FF5A, $FF5F, $FFA0, $FFA5, $FFAA, $FFAF, $FFF0, $FFF5,
    $FFFA, $FFFF);
...
begin
  ...
  self.matrix_base := @memory[0]; // Video matrix base
  self.char_base := @memory[0]; // Character generator base
  self.bitmap_base := @memory[0]; // Bitmap base
  self.mm0_color := 0;
...
begin
  ...
  if (((va and $F000) = $9000) or ((va and $F000) = $1000)) then
    ret := @char_rom[va and $FFF]
  else
    ret := @memory[va];
  get_physical := ret;
end;
...
begin
  case direccion of
    0, 2, 4, 6, 8, $A, $C, $E:
      ret := self.mx[direccion shr 1];
    1, 3, 5, 7, 9, $B, $D, $F:
      ret := self.my[direccion shr 1];
    $10:
      ret := self.mx8; // Sprite X position MSB
    $11:
      ret := (self.ctrl1 and $7F) or ((self.linea and $100) shr 1); // Control register 1
    $12:
      ret := self.linea; // Raster counter
    $13:
      ret := self.lpx; // Light pen X
    $14:
      ret := self.lpy; // Light pen Y
    $15:
      ret := self.me; // Sprite enable
    $16:
      ret := self.ctrl2 or $C0; // Control register 2
    $17:
      ret := self.mye; // Sprite Y expansion
    $18:
      ret := self.vbase or $01; // Memory pointers
    $19:
      ret := self.irq_flag or $70; // IRQ flags
    $1A:
      ret := self.irq_mask or $F0; // IRQ mask
    $1B:
      ret := self.mdp; // Sprite data priority
    $1C:
      ret := self.mmc; // Sprite multicolor
    $1D:
      ret := self.mxe; // Sprite X expansion
    $1E:
      begin // Sprite-sprite collision
        ret := self.clx_spr;
        self.clx_spr := 0; // Read and clear
      end;
    $1F:
      begin // Sprite-background collision
        ret := self.clx_bgr;
    ...
    $20:
      ret := self.ec or $F0;
    $21:
      ret := self.mc_color_lookup[0] or $F0;
    $22:
      ret := self.mc_color_lookup[1] or $F0;
    $23:
      ret := self.mc_color_lookup[2] or $F0;
    $24:
      ret := self.mc_color_lookup[3] or $F0;
    $25:
      ret := self.mm0 or $F0;
    $26:
      ret := self.mm1 or $F0;
    $27, $28, $29, $2A, $2B, $2C, $2D, $2E:
      ret := self.sc[direccion - $27] or $F0;
  else
    ret := $FF;
  end;
  read := ret;
...
begin
  ...
  if (self.irq_mask and $01) <> 0 then
  begin
...
begin
  case direccion of
    0, 2, 4, 6, 8, $A, $C, $E:
      self.mx[direccion shr 1] := (self.mx[direccion shr 1] and $FF00) or valor;
    1, 3, 5, 7, 9, $B, $D, $F:
      self.my[direccion shr 1] := valor;
    $10:
      begin
        self.mx8 := valor;
        j := 1;
        for i := 0 to 7 do
        begin
          if (self.mx8 and j) <> 0 then
            self.mx[i] := self.mx[i] or $100
          else
            self.mx[i] := self.mx[i] and $FF;
          j := j shl 1;
        end;
      end;
    $11:
      begin // Control register 1
        self.ctrl1 := valor;
        self.y_scroll := valor and 7;
        new_irq_raster := (self.irq_raster and $FF) or ((valor and $80) shl 1);
        if ((self.irq_raster <> new_irq_raster) and (self.linea = new_irq_raster)) then
          self.raster_irq;
    ...
    $15:
      self.me := valor; // Sprite enable
    $16:
      begin // Control register 2
        self.ctrl2 := valor;
    ...
    $17:
      self.mye := valor; // Sprite Y expansion
    $18:
      begin // Memory pointers
        self.vbase := valor;
    ...
    $19:
      begin // IRQ flags
        ...
        if (self.irq_flag and self.irq_mask) <> 0 then
    ...
    $1A:
      begin // IRQ mask
        ...
        if (self.irq_flag and self.irq_mask) <> 0 then
        begin // Trigger interrupt if pending and now allowed
          self.irq_flag := self.irq_flag or $80;
          self.irq_call(ASSERT_LINE);
        end
        else
    ...
    $1B:
      self.mdp := valor; // Sprite data priority
    $1C:
      self.mmc := valor; // Sprite multicolor
    $1D:
      self.mxe := valor; // Sprite X expansion
    $20:
      self.ec := valor and $F;
    $21:
      self.mc_color_lookup[0] := valor and $F;
    $22:
      self.mc_color_lookup[1] := valor and $F;
    $23:
      self.mc_color_lookup[2] := valor and $F;
    $24:
      self.mc_color_lookup[3] := valor and $F;
    $25:
      begin
        self.mm0 := valor;
...
begin
  ...
  for snum := 0 to 7 do
  begin
    if (((self.sprite_on and sbit) <> 0) and (self.mx[snum] < (DISPLAY_X - 32))) then
    begin
      ptemp := punbuf;
      ...
      fore_mask := (self.fore_mask_buf[ptempb] shl 24) or (self.fore_mask_buf[ptempb + 1] shl 16) or
        (self.fore_mask_buf[ptempb + 2] shl 8) or (self.fore_mask_buf[ptempb + 3] shl sshift) or
        (self.fore_mask_buf[ptempb + 4] shr (8 - sshift));
      if (self.mxe and sbit) <> 0 then
      begin // X_expanded
        if (self.mx[snum] >= (DISPLAY_X - 56)) then
          continue;
        fore_mask_r := (self.fore_mask_buf[ptempb + 4] shl 24) or
          (self.fore_mask_buf[ptempb + 5] shl 16) or (self.fore_mask_buf[ptempb + 6] shl 8) or
          (self.fore_mask_buf[ptempb + 7] shl sshift) or
          (self.fore_mask_buf[ptempb + 8] shr (8 - sshift));
        if (self.mmc and sbit) <> 0 then
        begin // Multicolor mode
          // Expand sprite data
          sdata_l := MultiExpTable[(sdata shr 24) and $FF] shl 16 or
            MultiExpTable[(sdata shr 16) and $FF];
          ...
          if (((fore_mask and (plane0_l or plane1_l)) <> 0) or
            ((fore_mask_r and (plane0_r or plane1_r)) <> 0)) then
          begin
            gfx_coll := gfx_coll or sbit;
            if (self.mdp and sbit) <> 0 then
            begin
          ...
          for f := 0 to 31 do
          begin
            if (plane1_l and $80000000) <> 0 then
            begin
              if (plane0_l and $80000000) <> 0 then
                col := mm1
              else
                col := color;
            end
            ...
            if self.spr_coll_buf[coll_pos + f] <> 0 then
          ...
          for f := 32 to 47 do
          begin
            if (plane1_r and $80000000) <> 0 then
            begin
              if (plane0_r and $80000000) <> 0 then
                col := mm1
              else
                col := color;
            end
            ...
            begin // Draw pixel if no collision
              ptemp^ := paleta[col];
              self.spr_coll_buf[coll_pos + f] := sbit;
            end;
            inc(ptemp);
        ...
        begin // Standard mode
          ...
          // Collision with graphics?
          if (((fore_mask and sdata_l) <> 0) or ((fore_mask_r and sdata_r) <> 0)) then
          begin
            gfx_coll := gfx_coll or sbit;
            if (self.mdp and sbit) <> 0 then
            begin
          ...
          for f := 0 to 31 do
          begin
            if (sdata_l and $80000000) <> 0 then
            begin
              // Collision with sprite?
              if self.spr_coll_buf[coll_pos + f] <> 0 then
              begin
          ...
          for f := 32 to 47 do
          begin
            if (sdata_r and $80000000) <> 0 then
            begin
              // Collision with sprite?
              if self.spr_coll_buf[coll_pos + f] <> 0 then
              begin
      ...
      begin // No expanded
        ...
        begin // Multicolor mode
          ...
          // Collision with graphics?
          if (fore_mask and (plane0_l or plane1_l)) <> 0 then
          begin
            gfx_coll := gfx_coll or sbit;
            if (self.mdp and sbit) <> 0 then
            begin
          ...
          begin
            ...
            if self.spr_coll_buf[coll_pos + f] <> 0 then
              spr_coll := self.spr_coll_buf[coll_pos + f] or sbit
            else
            begin
              ptemp^ := paleta[col];
              self.spr_coll_buf[coll_pos + f] := sbit;
...
begin
  ...
  begin
    ...
    if (spren and j) <> 0 then
      ...
      if (my[i] = (linea and $FF)) then
      begin
        self.mc[i] := 0;
        spron := spron or j;
        // No, turn sprite off when data counter exceeds 60 and increment counter
      end
      else if (self.mc[i] <> 63) then
      begin
        if (sprye and j) <> 0 then
        begin // Y expansion
          if (((self.my[i] xor (linea and $FF)) and 1) = 0) then
          begin
            self.mc[i] := self.mc[i] + 3;
            cycles_used := cycles_used + 2;
            if (self.mc[i] = 63) then
              spron := spron and not(j);
          end;
        end
        else
        begin
  ...
  begin
      ...
      case self.display_idx of
        ...
        1:
          ...
          begin
            ...
            begin // Standard mode in multicolor mode
              color := color_line[f] and $F;
              fore_mask_buf[f + 4] := data;
              for h := 0 to 7 do
              begin
        ...
        5, 6, 7:
          fillword(ptemp, 320, paleta[0]); // Invalid!
      end;
      self.vc := self.vc + 40;
    end
    else
    begin
      case self.display_idx of
        0, 1, 4:
          begin
            if (ctrl1 and $40) <> 0 then
              ptemp1 := get_physical($39FF)
            else
...
begin
  ...
  if (linea_ = self.irq_raster) then
    self.raster_irq;
  // Vblank?
  case linea_ of
    0 .. 15, 301 .. 311:
      begin // estoy en Vblank
        update := 63;
        exit;
      end;
    300:
      begin // empiezo vblank
        self.vblank;
        update := 63;
        exit;
      end;
  ...
  if (linea_ = $30) then
    self.bad_lines_enabled := (self.ctrl1 and $10) <> 0;
  // Estoy dentro de lo visible? Si no, estoy en vblank
  if ((linea_ >= FIRST_DISP_LINE) and (linea_ <= LAST_DISP_LINE)) then
  begin
    // Set video counter
    self.vc := self.vc_base;
    // Bad Line condition? Si es asi, cojo los datos para las siguientes 8 lineas!!
    if ((linea_ >= FIRST_DMA_LINE) and (linea_ <= LAST_DMA_LINE) and
      (((linea_ and 7) = self.y_scroll)) and bad_lines_enabled) then
    begin
      // Turn on display
    ...
    case linea_ of
      16 .. 50, 251 .. 299:
        fillword(ptemp, 384, paleta[self.ec]); // borde
      51 .. 54, 247 .. 250:
        if self.row25 then
          pinta_linea
        else
    ...
    begin
      ...
      self.rc := self.rc + 1;
    if ((linea_ >= FIRST_DMA_LINE - 1) and (linea_ <= LAST_DMA_LINE - 1) and
      ((((linea_ + 1) and 7) = self.y_scroll)) and self.bad_lines_enabled) then
      self.rc := 0;
  end;
  if (self.me or self.sprite_on) <> 0 then
    cycles_left := cycles_left - self.update_mc(linea_);
  update := cycles_left;
end;
