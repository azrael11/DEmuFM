...
const
  ...
  cpc_paleta: array [0 .. 31] of dword = ($808080, $808080, $00FF80, $FFFF80, $000080, $FF0080, $008080,
    $FF8080, $FF0080, $FFFF80, $FFFF00, $FFFFFF, $FF0000, $FF00FF, $FF8000, $FF80FF, $000080, $00FF80,
    $00FF00, $00FFFF, $000000, $0000FF, $008000, $0080FF, $800080, $80FF80, $80FF00, $80FFFF, $800000,
    $8000FF, $808000, $8080FF);
  green_classic: array [0 .. 31] of single = (0.5647, 0.5647, 0.7529, 0.9412, 0.1882, 0.3765, 0.4706, 0.6588,
    0.3765, 0.9412, 0.9098, 0.9725, 0.3451, 0.4078, 0.6275, 0.6902, 0.1882, 0.7529, 0.7216, 0.7843, 0.1569,
    0.2196, 0.4392, 0.5020, 0.2824, 0.8471, 0.8157, 0.8784, 0.2510, 0.3137, 0.5333, 0.5961);
  z80t_a: array [0 .. $FF] of byte = (4, 12, 8, 8, 4, 4, 8, 4, 4, 12, 8, 8, 4, 4, 8, 4, 12, 12, 8, 8, 4, 4, 8,
    4, 12, 12, 8, 8, 4, 4, 8, 4, 8, 12, 20, 8, 4, 4, 8, 4, 8, 12, 20, 8, 4, 4, 8, 4, 8, 12, 16, 8, 12, 12, 12,
    4, 8, 12, 16, 8, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4,
    4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 8, 8, 8, 8, 8, 8, 4, 8, 4, 4, 4, 4, 4,
    4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4,
    4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 8, 12, 12,
    12, 12, 16, 8, 16, 8, 12, 12, 4, 12, 20, 8, 16, 8, 12, 12, 12, 12, 16, 8, 16, 8, 4, 12, 12, 12, 4, 8, 16,
    8, 12, 12, 24, 12, 16, 8, 16, 8, 4, 12, 4, 12, 4, 8, 16, 8, 12, 12, 4, 12, 16, 8, 16, 8, 8, 12, 4, 12,
    4, 8, 16);
  z80t_cb_a: array [0 .. $FF] of byte = (4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4,
    12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4,
    4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4,
    4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4,
    8, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4,
    4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4,
    4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4,
    4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4, 4, 4, 4, 4, 4, 4, 12, 4);
  z80t_ed_a: array [0 .. $FF] of byte = (4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 12, 12, 12, 20, 4, 12, 4, 8, 12, 12, 12, 20, 4, 12, 4, 8, 12, 12, 12, 20, 4, 12, 4, 8,
    12, 12, 12, 20, 4, 12, 4, 8, 12, 12, 12, 20, 4, 12, 4, 16, 12, 12, 12, 20, 4, 12, 4, 16, 12, 12, 12, 20,
    4, 12, 4, 4, 12, 12, 12, 20, 4, 12, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 16, 12, 16, 16, 4, 4, 4, 4, 16, 12, 16, 16, 4, 4, 4, 4, 16, 12, 16, 16,
    4, 4, 4, 4, 16, 12, 16, 16, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4);
  z80t_dd_a: array [0 .. $FF] of byte = (4, 12, 8, 8, 4, 4, 8, 4, 4, 12, 8, 8, 4, 4, 8, 4, 12, 12, 8, 8, 4, 4,
    8, 4, 12, 12, 8, 8, 4, 4, 8, 4, 8, 12, 20, 8, 4, 4, 8, 4, 8, 12, 20, 8, 4, 4, 8, 4, 8, 12, 16, 8, 20, 20,
    20, 4, 8, 12, 16, 8, 4, 4, 8, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16,
    4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 16, 16, 16, 16, 16, 16, 4,
    16, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4,
    4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4, 4, 4, 4, 16, 4, 4, 4, 4,
    4, 4, 4, 16, 4, 8, 12, 12, 12, 12, 16, 8, 16, 8, 12, 12, 8, 12, 20, 8, 16, 8, 12, 12, 12, 12, 16, 8, 16,
    8, 4, 12, 12, 12, 4, 8, 16, 8, 12, 12, 24, 12, 16, 8, 16, 8, 4, 12, 4, 12, 4, 8, 16, 8, 12, 12, 4, 12, 16,
    8, 16, 8, 8, 12, 4, 12, 4, 8, 16);
  z80t_ddcb_a: array [0 .. $FF] of byte = (16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 12, 12, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
...
begin
  ...
  begin
    ...
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $FE)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or 1);
    // if arcade_input.down[0] then
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $FD)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or 2);
    // if arcade_input.left[0] then
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $FB)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or 4);
    // if arcade_input.right[0] then
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $F7)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or $8);
    // if arcade_input.but0[0] then
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $EF)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or $10);
    // if arcade_input.but1[0] then
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $DF)
    // else
    // cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or $20);
    // // P2
    // if arcade_input.up[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $FE)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or 1);
    // if arcade_input.down[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $FD)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or 2);
    // if arcade_input.left[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $FB)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or 4);
    // if arcade_input.right[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $F7)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or 8);
    // if arcade_input.but0[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $EF)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or $10);
    // if arcade_input.but1[1] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $DF)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or $20);
  end
  ...
  begin
    ...
    // Line 0
    if keyboard[KEYBOARD_UP] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $FE)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $1);
    if keyboard[KEYBOARD_RIGHT] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $FD)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $2);
    if keyboard[KEYBOARD_DOWN] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $FB)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $4);
    if keyboard[KEYBOARD_N9] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $F7)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $8);
    if keyboard[KEYBOARD_N6] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $EF)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $10);
    if keyboard[KEYBOARD_N3] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $DF)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $20);
    if keyboard[KEYBOARD_HOME] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $BF)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $40);
    if keyboard[KEYBOARD_NDOT] then
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] and $7F)
    else
      cpc_ppi.keyb_val[0] := (cpc_ppi.keyb_val[0] or $80);
    // Line 1
    if keyboard[KEYBOARD_LEFT] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $FE)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or 1);
    if keyboard[KEYBOARD_LALT] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $FD)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or 2);
    if keyboard[KEYBOARD_N7] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $FB)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or $4);
    if keyboard[KEYBOARD_N8] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $F7)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or $8);
    if keyboard[KEYBOARD_N1] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $DF)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or $20);
    if keyboard[KEYBOARD_N2] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $BF)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or $40);
    if keyboard[KEYBOARD_N0] then
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] and $7F)
    else
      cpc_ppi.keyb_val[1] := (cpc_ppi.keyb_val[1] or $80);
    // Line 2
    // if keyboard[KEYBOARD_FILA0_T0] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $FE)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or 1);
    // if keyboard[KEYBOARD_FILA1_T2] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $FD)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or 2);
    // if (keyboard[KEYBOARD_RETURN] or keyboard[KEYBOARD_NRETURN]) then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $FB)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or 4);
    // if keyboard[KEYBOARD_FILA2_T3] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $F7)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or 8);
    // if keyboard[KEYBOARD_N4] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $EF)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or $10);
    // if (keyboard[KEYBOARD_LSHIFT] or keyboard[KEYBOARD_RSHIFT]) then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $DF)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or $20);
    // if keyboard[KEYBOARD_FILA3_T3] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $BF)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or $40);
    // if keyboard[KEYBOARD_LCTRL] then
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] and $7F)
    // else
    // cpc_ppi.keyb_val[2] := (cpc_ppi.keyb_val[2] or $80);
    // // Line 3
    // if keyboard[KEYBOARD_FILA0_T2] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $FE)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or 1);
    // if keyboard[KEYBOARD_FILA0_T1] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $FD)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or 2);
    // if keyboard[KEYBOARD_FILA1_T1] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $FB)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or 4);
    // if keyboard[KEYBOARD_p] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $F7)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or 8);
    // if keyboard[KEYBOARD_FILA2_T2] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $EF)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or $10);
    // if keyboard[KEYBOARD_FILA2_T1] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $DF)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or $20);
    // if keyboard[KEYBOARD_FILA3_T2] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $BF)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or $40);
    // if keyboard[KEYBOARD_FILA3_T1] then
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] and $7F)
    // else
    // cpc_ppi.keyb_val[3] := (cpc_ppi.keyb_val[3] or $80);
    // // Line 4
    // if keyboard[KEYBOARD_0] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $FE)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or 1);
    // if keyboard[KEYBOARD_9] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $FD)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or 2);
    // if keyboard[KEYBOARD_o] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $FB)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or 4);
    // if keyboard[KEYBOARD_i] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $F7)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or 8);
    // if keyboard[KEYBOARD_l] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $EF)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or $10);
    // if keyboard[KEYBOARD_k] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $DF)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or $20);
    // if keyboard[KEYBOARD_m] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $BF)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or $40);
    // if keyboard[KEYBOARD_FILA3_T0] then
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] and $7F)
    // else
    // cpc_ppi.keyb_val[4] := (cpc_ppi.keyb_val[4] or $80);
    // // Line 5
    // if keyboard[KEYBOARD_8] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $FE)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or 1);
    // if keyboard[KEYBOARD_7] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $FD)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or 2);
    // if keyboard[KEYBOARD_u] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $FB)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or 4);
    // if keyboard[KEYBOARD_y] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $F7)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or 8);
    // if keyboard[KEYBOARD_h] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $EF)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or $10);
    // if keyboard[KEYBOARD_j] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $DF)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or $20);
    // if keyboard[KEYBOARD_n] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $BF)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or $40);
    // if keyboard[KEYBOARD_space] then
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] and $7F)
    // else
    // cpc_ppi.keyb_val[5] := (cpc_ppi.keyb_val[5] or $80);
    // // Line 6
    ...
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $BF)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or $40);
    // if keyboard[KEYBOARD_v] then
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] and $7F)
    // else
    // cpc_ppi.keyb_val[6] := (cpc_ppi.keyb_val[6] or $80);
    // // Line 7
    // if keyboard[KEYBOARD_4] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $FE)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or 1);
    // if keyboard[KEYBOARD_3] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $FD)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or 2);
    // if keyboard[KEYBOARD_e] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $FB)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or 4);
    // if keyboard[KEYBOARD_w] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $F7)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or 8);
    // if keyboard[KEYBOARD_s] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $EF)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or $10);
    // if keyboard[KEYBOARD_d] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $DF)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or $20);
    // if keyboard[KEYBOARD_c] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $BF)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or $40);
    // if keyboard[KEYBOARD_x] then
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] and $7F)
    // else
    // cpc_ppi.keyb_val[7] := (cpc_ppi.keyb_val[7] or $80);
    // // Line 8
    // if keyboard[KEYBOARD_1] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $FE)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or 1);
    // if keyboard[KEYBOARD_2] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $FD)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or 2);
    // if keyboard[KEYBOARD_escape] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $FB)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or 4);
    // if keyboard[KEYBOARD_q] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $F7)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or 8);
    // if keyboard[KEYBOARD_tab] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $EF)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or $10);
    // if keyboard[KEYBOARD_a] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $DF)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or $20);
    // if keyboard[KEYBOARD_CAPSLOCK] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $BF)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or $40);
    // if keyboard[KEYBOARD_z] then
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] and $7F)
    // else
    // cpc_ppi.keyb_val[8] := (cpc_ppi.keyb_val[8] or $80);
    // Line 9
    // JOY UP,JOY DOWN,JOY LEFT,JOY RIGHT,FIRE1,FIRE2 --> Arcade
    if keyboard[KEYBOARD_BACKSPACE] then
      cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] and $7F)
    else
      cpc_ppi.keyb_val[9] := (cpc_ppi.keyb_val[9] or $80);
  end;
end;
...
begin
  ...
  begin
    ...
    eventos_cpc;
    actualiza_trozo(0, 0, PANTALLA_LARGO, PANTALLA_ALTO - PANTALLA_VSYNC, 1, 0, 0, PANTALLA_LARGO,
      PANTALLA_ALTO - PANTALLA_VSYNC, PANT_TEMP);
    video_sync;
  end;
end;
...
begin
  case direccion of
    0 .. $3FFF:
      if (not(cpc_dandanator.follow_rom_ena) and cpc_dandanator.enabled and cpc_dandanator.zone0_ena and
        (cpc_dandanator.zone0_seg = 0)) then
    ...
    $4000 .. $7FFF:
      if (cpc_dandanator.enabled and cpc_dandanator.zone1_ena and (cpc_dandanator.zone1_seg = 0)) then
    ...
    $8000 .. $BFFF:
      if (not(cpc_dandanator.follow_rom_ena) and cpc_dandanator.enabled and cpc_dandanator.zone0_ena and
        (cpc_dandanator.zone0_seg = 1)) then
    ...
    $C000 .. $FFFF:
      if (cpc_dandanator.enabled and cpc_dandanator.zone1_ena and (cpc_dandanator.zone1_seg = 1)) then
        cpc_getbyte := cpc_dandanator.rom[cpc_dandanator.zone1_rom, direccion and $3FFF]
      else if cpc_ga.rom_high then
        cpc_getbyte := cpc_rom[cpc_ga.rom_selected].data[direccion and $3FFF]
      else
        cpc_getbyte := cpc_mem[cpc_ga.marco[3], direccion and $3FFF];
  end;
end;
...
begin
  ...
  case (val and 7) of
    ...
    4:
      cpc_ga.marco[1] := 0 + pagina;
    5:
      cpc_ga.marco[1] := 1 + pagina;
    6:
      cpc_ga.marco[1] := 2 + pagina;
    7:
      cpc_ga.marco[1] := 3 + pagina;
  end;
  cpc_ga.marco_latch := val and 7;
end;
  ...
  case (val shr 6) of
    $0:
      if (val and $10) = 0 then
        cpc_ga.pen := val and $F // Select pen
      else
        cpc_ga.pen := $10; // Border
    $1:
      cpc_ga.pal[cpc_ga.pen] := val and $1F; // Change pen colour
    $2:
      begin // ROM banking and mode switch
...
const
  masks: array [0 .. $F] of byte = ($FF, $FF, $FF, $FF, $7F, $1F, $7F, $7F, $FF, $1F, $7F, $1F, $3F, $FF,
    $3F, $FF);
begin
  case (port and $3) of
    $0:
          ...
          5:
            ...
            begin
              ...
              cpc_crt.pant_addr := ((cpc_crt.line_address and $3FF) shl 1) or
                ((cpc_crt.state_row_address and $7) shl 11) or ((cpc_crt.line_address and $3000) shl 2);
              cpc_crt.adj_count := 0;
            end;
        end;
      end;
...
begin
  ...
  begin
    if cpc_rom[valor and $F].enabled then
      cpc_ga.rom_selected := valor and $F
    else
      cpc_ga.rom_selected := 0;
  end;
  if (puerto and $1000) = 0 then
    exit; // printer
  if (puerto and $0800) = 0 then
    pia8255_0.write((puerto and $300) shr 8, valor);
  if (puerto and $0400) = 0 then
  begin // Expansion
    ...
    begin // FDC
      case (puerto and $101) of
        $0, 1:
          WriteFDCMotor(valor); // FDC Motor
        $100, $101:
          WriteFDCData(valor); // FDC Data
      end;
    end
  end;
end;
...
begin
  ...
  if (puerto and $4000) = 0 then
    res := read_crtc(puerto shr 8);
  if (puerto and $0800) = 0 then
    res := pia8255_0.read((puerto and $300) shr 8);
  if (puerto and $0400) = 0 then
  begin // Expansion
    // puerto and $20=0 Serial
    // puerto and $40=0 Reserved
    ...
    begin // FDC
      case (puerto and $101) of
        $0, 1:
          ; // Not used
        $100:
          res := ReadFDCStatus; // FDC Main status
        $101:
          res := ReadFDCData // FDC Read data
      end;
    end;
  end;
  cpc_inbyte := res;
...
begin
  case cpc_ppi.ay_control of
    0:
      cpc_ppi.port_a_read_latch := $FF;
    1:
      cpc_ppi.port_a_read_latch := ay8910_0.read;
    2:
      ay8910_0.write(cpc_ppi.port_a_write_latch);
    3:
      ay8910_0.control(cpc_ppi.port_a_write_latch);
  end;
end;
      ...
      begin
        ...
        case cpc_ga.video_mode of
          0:
            begin
              // 1 5 3 7    0 4 2 6
              p1 := ((val and 2) shl 2) or ((val and $20) shr 3) or ((val and 8) shr 2) or
                ((val and $80) shr 7);
              p2 := ((val and 1) shl 3) or ((val and $10) shr 2) or ((val and 4) shr 1) or
                ((val and $40) shr 6);
...
begin
  ...
  if (cinta_tzx.cargada and cinta_tzx.play_tape) then
    play_cinta_tzx(trunc(estados_t * 0.875));
  // Clock a el video...
  for f := 1 to (estados_t shr 2) do
  begin
    if ((cpc_crt.pant_x < cpc_crt.char_total) and cpc_crt.line_is_visible) then
      draw_pixels;
    if cpc_crt.state_hsync then
    begin
      tempb := cpc_crt.regs[3] and $F;
      if tempb = 0 then
        tempb := 16;
      if cpc_crt.hsync_counter = tempb then
        cpc_crt.state_hsync := false
      else
        cpc_crt.hsync_counter := cpc_crt.hsync_counter + 1;
    end;
    if (cpc_crt.regs[0] >= cpc_crt.regs[2]) then
    begin
      if (cpc_crt.character_counter = cpc_crt.regs[2]) then
      begin
        cpc_crt.hsync_counter := 0;
        cpc_crt.state_hsync := true;
      end;
    end;
    if (cpc_crt.character_counter = cpc_crt.regs[1]) then
      cpc_crt.end_of_line_address := cpc_crt.state_refresh_address
    else
      cpc_crt.state_refresh_address := (cpc_crt.state_refresh_address + 1) and $3FFF;
    if (cpc_crt.character_counter = cpc_crt.regs[0]) then
    begin
      do_end_of_line;
      ...
      cpc_crt.character_counter := cpc_crt.character_counter + 1;
    if (cpc_crt.was_hsync and not(cpc_crt.state_hsync)) then
      ga_exec;
...
var
  z80: npreg_z80;
begin
  if (cpc_dandanator.halted or not(cpc_dandanator.enabled)) then
    exit;
  ...
  if ((cpc_dandanator.fd_count = 2) and (opcode <> $FD)) then
  begin
...
begin
  ...
  if extension = 'CDT' then
    resultado := abrir_cdt(datos, longitud);
  if extension = 'TZX' then
    resultado := abrir_tzx(datos, longitud);
  if extension = 'CSW' then
    resultado := abrir_csw(datos, longitud);
  if extension = 'WAV' then
    resultado := abrir_wav(datos, longitud, 4000000);
  if extension = 'ROM' then
  begin
    ...
    begin
      // MessageDlg('Error cargando ROM.' + chr(10) + chr(13) + 'Error loading the ROM.',
  ...
  begin
    ...
    begin
      // MessageDlg('Error cargando snapshot.' + chr(10) + chr(13) + 'Error loading the snapshot.',
      // mtInformation, [mbOk], 0);
    end;
  end;
  if es_cinta then
  begin
    ...
    begin
      // MessageDlg('Error cargando cinta/CSW/WAV.' + chr(10) + chr(13) +
      // 'Error loading tape/CSW/WAV.', mtInformation, [mbOk], 0);
    end;
  end;
  freemem(datos);
...
begin
  ...
  begin
    ...
    case indice of
      1:
        correcto := grabar_amstrad_sna(nombre);
    end;
...
begin
  if cpc_ppi.tape_motor then
  begin // Poner en marcha la cinta
    if not(cinta_tzx.play_tape) then
    begin
      // main_screen.rapido := true;
      // tape_window1.fPlayCinta(nil);
      if not(cinta_tzx.play_once) then
...
begin
  cpc_load_roms := false;
  for f := 0 to 15 do
    cpc_rom[f].enabled := false;
  if cpc_ga.cpc_model = 4 then
  begin
    cadena := file_name_only(changefileext(extractfilename(cpc_rom[0].name), ''));
    if extension_fichero(cpc_rom[0].name) = 'ZIP' then
      tempb := carga_rom_zip(cpc_rom[0].name, cadena + '.ROM', @memoria_temp[0], $4000, 0, false)
    else
    begin
    ...
    begin
      ...
      cpc_ga.cpc_model := 0;
      if not(roms_load(@memoria_temp, cpc6128_rom)) then
        exit;
    end;
    if main_vars.machine_type <> 7 then
    begin
      if not(roms_load(@cpc_rom[7].data, ams_rom)) then
        exit;
  ...
  begin
    case main_vars.machine_type of
        ...
        begin
          ...
          case cpc_ga.cpc_model of
            0:
              tempb := true;
            1:
              if not(roms_load(@memoria_temp, cpc464f_rom)) then
              begin
            ...
            2:
              if not(roms_load(@memoria_temp, cpc464sp_rom)) then
              begin
            ...
            3:
              if not(roms_load(@memoria_temp, cpc464d_rom)) then
              begin
          ...
          if tempb then
            if not(roms_load(@memoria_temp, cpc464_rom)) then
              exit;
          cpc_rom[0].enabled := true;
        end;
      8:
        begin
          if not(roms_load(@cpc_rom[7].data, ams_rom)) then
            exit;
          cpc_rom[7].enabled := true;
          if not(roms_load(@memoria_temp, cpc664_rom)) then
            exit;
          cpc_ga.cpc_model := 0;
          cpc_rom[0].enabled := true;
        end;
      9:
        begin
          if not(roms_load(@cpc_rom[7].data[0], ams_rom)) then
            exit;
          cpc_rom[7].enabled := true;
          tempb := false;
          case cpc_ga.cpc_model of
            0:
              tempb := true;
            1:
              if not(roms_load(@memoria_temp, cpc6128f_rom)) then
              begin
                // MessageDlg('French ROM not found. Loading UK ROM...', mtInformation, [mbOk], 0);
                cpc_ga.cpc_model := 0;
                tempb := true;
            ...
            2:
              if not(roms_load(@memoria_temp, cpc6128sp_rom)) then
              begin
                // MessageDlg('Spanish ROM not found. Loading UK ROM...', mtInformation, [mbOk], 0);
                cpc_ga.cpc_model := 0;
                tempb := true;
            ...
            3:
              if not(roms_load(@memoria_temp, cpc6128d_rom)) then
              begin
                // MessageDlg('Danish ROM not found. Loading UK ROM...', mtInformation, [mbOk], 0);
                cpc_ga.cpc_model := 0;
                tempb := true;
  ...
  begin
    ...
    begin
      ...
      if extension_fichero(cpc_rom[f].name) = 'ZIP' then
        tempb := carga_rom_zip(cpc_rom[f].name, cadena + '.ROM', @cpc_rom[f].data, $4000, 0, false)
      else
      begin
...
var
  ...
  f: byte;
begin
  if not(open_qsnapshot_load('cpc' + inttostr(main_vars.machine_type) + nombre)) then
    exit;
  getmem(data, 200);
  // MISC
  ...
  // MEM
  for f := 0 to 31 do
    loaddata_qsnapshot(@cpc_mem[f, 0]);
  for f := 0 to 16 do
    loaddata_qsnapshot(@cpc_rom[f]);
  // Vars
...
var
  ...
  f: byte;
begin
  open_qsnapshot_save('cpc' + inttostr(main_vars.machine_type) + nombre);
  getmem(data, 200);
  // MISC
  buffer[0] := tape_timer;
  ...
  // MEM
  for f := 0 to 31 do
    savedata_qsnapshot(@cpc_mem[f, 0], $4000);
  size := sizeof(tcpc_rom);
  for f := 0 to 16 do
    savedata_qsnapshot(@cpc_rom[f], size);
  // Vars
...
var
  ...
  temps: single;
begin
  machine_calls.general_loop := cpc_main;
  machine_calls.reset := cpc_reset;
  machine_calls.fps_max := 50.080128205;
  machine_calls.close := cpc_close;
