...
begin
  ...
  if (self.OPL.rhythm and $20) = 0 then
  begin
...
begin
  case timer_num of
    0:
      if period = 0 then
        timers.enabled(self.timer1, false)
      else
      begin
    ...
    1:
      if period = 0 then
        timers.enabled(self.timer2, false)
      else
      begin
