...
const
  ...
  STATE_NIBBLE_MSN = 11;
  STATE_NIBBLE_LSN = 12;
  upd7759_step: array [0 .. 15, 0 .. 15] of integer = ((0, 0, 1, 2, 3, 5, 7, 10, 0, 0, -1, -2, -3,
    -5, -7, -10), (0, 1, 2, 3, 4, 6, 8, 13, 0, -1, -2, -3, -4, -6, -8, -13),
    (0, 1, 2, 4, 5, 7, 10, 15, 0, -1, -2, -4, -5, -7, -10, -15), (0, 1, 3, 4, 6, 9, 13, 19, 0, -1,
    -3, -4, -6, -9, -13, -19), (0, 2, 3, 5, 8, 11, 15, 23, 0, -2, -3, -5, -8, -11, -15, -23),
  ...
  upd7759_state_table: array [0 .. 15] of integer = (-1, -1, 0, 0, 1, 2, 2, 3, -1, -1, 0, 0,
    1, 2, 2, 3);
...
begin
  ...
  if ((self.state = STATE_IDLE) and ((not(oldstart) and 1) <> 0) and ((self.start and 1) <> 0) and
    ((self.reset_pin and 1) <> 0)) then
  begin
