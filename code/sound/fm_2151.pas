...
const
  ...
  eg_rate_select: array [0 .. (32 + 64 + 32) - 1] of byte = (
    ...
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS, 18 * RATE_STEPS,
    18 * RATE_STEPS, 18 * RATE_STEPS,
    ...
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS, 16 * RATE_STEPS,
    16 * RATE_STEPS, 16 * RATE_STEPS);
  ...
  eg_rate_shift: array [0 .. (32 + 64 + 32) - 1] of byte = (
    ...
    4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 2, 1, 1, 1, 1, 0, 0, 0, 0,
    // rate 12 */
    0, 0, 0, 0,
    // rate 13 */
    0, 0, 0, 0,
  ...
  phaseinc_rom: array [0 .. 767] of word = (1299, 1300, 1301, 1302, 1303, 1304, 1305, 1306, 1308,
    1309, 1310, 1311, 1313, 1314, 1315, 1316, 1318, 1319, 1320, 1321, 1322, 1323, 1324, 1325, 1327,
    1328, 1329, 1330, 1332, 1333, 1334, 1335, 1337, 1338, 1339, 1340, 1341, 1342, 1343, 1344, 1346,
    1347, 1348, 1349, 1351, 1352, 1353, 1354, 1356, 1357, 1358, 1359, 1361, 1362, 1363, 1364, 1366,
    1367, 1368, 1369, 1371, 1372, 1373, 1374, 1376, 1377, 1378, 1379, 1381, 1382, 1383, 1384, 1386,
    2579, 2581, 2583, 2586, 2589, 2590, 2593);
  ...
  lfo_noise_waveform: array [0 .. 255] of byte = ($FF, $EE, $D3, $80, $58, $DA, $7F, $94, $9E, $E3,
    $FA, $00, $4D, $FA, $FF, $6A, $7A, $DE, $49, $F6, $00, $33, $BB, $63, $91, $60, $51, $FF, $00,
    $D8, $7F, $DE, $DC, $73, $21, $85, $B2, $9C, $5D, $24, $CD, $91, $9E, $76, $7F, $20, $FB, $F3,
    $00, $A6, $3E, $42, $27, $69, $AE, $33, $45, $44, $11, $41, $72, $73, $DF, $A2,

    $32, $BD, $7E, $A8, $13, $EB, $D3, $15, $DD, $FB, $C9, $9D, $61, $2F, $BE, $9D, $23, $65, $51,
    $6A, $84, $F9, $C9, $D7, $23, $BF, $65, $19, $DC, $03, $F3, $24, $33, $B6, $1E, $57, $5C, $AC,
    $25, $89, $4D, $C5, $9C, $99, $15, $07, $CF, $BA, $C5, $9B, $15, $4D, $8D, $2A, $1E, $1F, $EA,
    $2B, $2F, $64, $A9, $50, $3D, $AB,

    $50, $77, $E9, $C0, $AC, $6D, $3F, $CA, $CF, $71, $7D, $80, $A6, $FD, $FF, $B5, $BD, $6F, $24,
    $7B, $00, $99, $5D, $B1, $48, $B0, $28, $7F, $80, $EC, $BF, $6F, $6E, $39, $90, $42, $D9, $4E,
    $2E, $12, $66, $C8, $CF, $3B, $3F, $10, $7D, $79, $00, $D3, $1F, $21, $93, $34, $D7, $19, $22,
    $A2, $08, $20, $B9, $B9, $EF, $51,

    $99, $DE, $BF, $D4, $09, $75, $E9, $8A, $EE, $FD, $E4, $4E, $30, $17, $DF, $CE, $11, $B2, $28,
    $35, $C2, $7C, $64, $EB, $91, $5F, $32, $0C, $6E, $00, $F9, $92, $19, $DB, $8F, $AB, $AE, $D6,
    $12, $C4, $26, $62, $CE, $CC, $0A, $03, $E7, $DD, $E2, $4D, $8A, $A6, $46, $95, $0F, $8F, $F5,
    $15, $97, $32, $D4, $28, $1E, $55);
      ...
      case (op.state) of
        EG_ATT:
          begin // attack phase */
            ...
            begin
              tmp := (not(op.volume) * (eg_inc[op.eg_sel_ar + ((chip.eg_cnt shr op.eg_sh_ar) and
                7)])) / 16;
              op.volume := trunc(op.volume + tmp);
              if (op.volume <= MIN_ATT_INDEX) then
              begin
          ...
          begin // decay phase */
            ...
            begin
              op.volume := op.volume + eg_inc
                [op.eg_sel_d1r + ((chip.eg_cnt shr op.eg_sh_d1r) and 7)];
        ...
        EG_SUS:
          begin // sustain phase */
            ...
            begin
              op.volume := op.volume + eg_inc
                [op.eg_sel_d2r + ((chip.eg_cnt shr op.eg_sh_d2r) and 7)];
