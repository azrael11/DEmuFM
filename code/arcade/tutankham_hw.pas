...
const
  tutan_rom: array [0 .. 14] of tipo_roms = ((n: 'm1.1h'; l: $1000; p: $0; crc: $DA18679F),
  ...
  tutan_sound: array [0 .. 1] of tipo_roms = ((n: 's1.7a'; l: $1000; p: 0; crc: $B52D01FA),
    (n: 's2.8a'; l: $1000; p: $1000; crc: $9DB5C0CE));
  // Dip
  tutan_dip_a: array [0 .. 2] of def_dip = ((mask: $0F; name: 'Coin A'; number: 16;
    ...
    dip_name: '1C 7C'), ())), ());
  tutan_dip_b: array [0 .. 6] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    dip: ((dip_val: $3; dip_name: '3'), (dip_val: $1; dip_name: '4'), (dip_val: $2;
    ...
    dip: ((dip_val: $8; dip_name: '30K'), (dip_val: $0; dip_name: '40K'), (), (), (), (), (), (),
    ...
    (), ())), (mask: $40; name: 'Flash Bomb'; number: 2;
    dip: ((dip_val: $40; dip_name: '1 per Life'), (dip_val: $0; dip_name: '1 per Game'), (), (), (),
