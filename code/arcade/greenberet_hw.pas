...
const
  // Green Beret
  gberet_rom: array [0 .. 2] of tipo_roms = ((n: '577l03.10c'; l: $4000; p: 0; crc: $AE29E4FF),
    (n: '577l02.8c'; l: $4000; p: $4000; crc: $240836A5), (n: '577l01.7c'; l: $4000; p: $8000;
    crc: $41FA3E1F));
  gberet_pal: array [0 .. 2] of tipo_roms = ((n: '577h09.2f'; l: $20; p: 0; crc: $C15E7C80),
    (n: '577h11.6f'; l: $100; p: $20; crc: $2A1A992B), (n: '577h10.5f'; l: $100; p: $120;
    crc: $E9DE1E53));
  gberet_char: tipo_roms = (n: '577l07.3f'; l: $4000; p: 0; crc: $4DA7BD1B);
  gberet_sprites: array [0 .. 3] of tipo_roms = ((n: '577l06.5e'; l: $4000; p: 0; crc: $0F1CB0CA),
    (n: '577l05.4e'; l: $4000; p: $4000; crc: $523A8B66), (n: '577l08.4f'; l: $4000; p: $8000;
    crc: $883933A4), (n: '577l04.3e'; l: $4000; p: $C000; crc: $CCECDA4C));
  // Mr Goemon
  mrgoemon_rom: array [0 .. 1] of tipo_roms = ((n: '621d01.10c'; l: $8000; p: 0; crc: $B2219C56),
    (n: '621d02.12c'; l: $8000; p: $8000; crc: $C3337A97));
  mrgoemon_pal: array [0 .. 2] of tipo_roms = ((n: '621a06.5f'; l: $20; p: 0; crc: $7C90DE5F),
    (n: '621a08.7f'; l: $100; p: $20; crc: $2FB244DD), (n: '621a07.6f'; l: $100; p: $120;
    crc: $3980ACDC));
  mrgoemon_char: tipo_roms = (n: '621a05.6d'; l: $4000; p: 0; crc: $F0A6DFC5);
  mrgoemon_sprites: array [0 .. 1] of tipo_roms = ((n: '621d03.4d'; l: $8000; p: 0; crc: $66F2B973),
    (n: '621d04.5d'; l: $8000; p: $8000; crc: $47DF6301));
  // Dip
  gberet_dip_a: array [0 .. 2] of def_dip = ((mask: $0F; name: 'Coin A'; number: 16;
  ...
  gberet_dip_b: array [0 .. 5] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    ...
    dip_name: '40K 80K+'), (dip_val: $8; dip_name: '50K 100K+'), (dip_val: $0;
    dip_name: '50K 200K+'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $60;
    ...
    dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), ());
  gberet_dip_c: array [0 .. 2] of def_dip = ((mask: $1; name: 'Flip Screen'; number: 2;
    ...
    (), (), (), (), (), (), (), (), ())), ());
  mrgoemon_dip_b: array [0 .. 5] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    dip: ((dip_val: $3; dip_name: '2'), (dip_val: $2; dip_name: '3'), (dip_val: $1;
    dip_name: '5'), (dip_val: $0; dip_name: '7'), (), (), (), (), (), (), (), (), (), (), (), ())),
    (mask: $4; name: 'Cabinet'; number: 2; dip: ((dip_val: $0; dip_name: 'Upright'), (dip_val: $4;
    dip_name: 'Cocktail'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $18;
    name: 'Bonus Life'; number: 4; dip: ((dip_val: $18; dip_name: '20K 60K+'), (dip_val: $10;
    dip_name: '30K 70K+'), (dip_val: $8; dip_name: '40K 80K+'), (dip_val: $0; dip_name: '50K 90K+'),
  ...
  begin
    ...
    begin
      ...
      if (atrib and $80) <> 0 then
        ...
        put_gfx_mask_flip(x * 8, y * 8, nchar, color, 3, 0, 0, $F, (atrib and $10) <> 0,
          (atrib and $20) <> 0);
...
begin
  case direccion of
    ...
    $E020 .. $E03F:
      begin
        scroll_lineas[direccion and $1F] := (scroll_lineas[direccion and $1F] and $FF) or
          ((valor and 1) shl 8);
        memory[direccion] := valor;
      end;
    $E043:
...
begin
  if ((memory[$DB06] = 3) and (memory[$DB07] = $30) and (memory[$DB08] = 0) and
    (memory[$DB0B] = $1C)) then
  begin
