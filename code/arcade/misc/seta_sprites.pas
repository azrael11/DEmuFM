    ...
    begin
      ...
      begin
        ...
        begin
          ...
          update_gfx_sprite(sx, sy, self.screen_gfx, self.sprite_gfx);
        end
        else
        begin
...
begin
  ...
  begin
    ...
    if (self.control[0] and $40) <> 0 then
    begin
      sy := self.spritey[f] + 2;
      flipx := (atrib and $80) = 0;
      flipy := (atrib and $40) = 0;
...
begin
  if (self.control[1] and $20) = 0 then
  begin
    if (self.control[1] and $40) <> 0 then
    begin
