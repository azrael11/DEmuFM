...
begin
  ...
  case direccion of
    0:
      arkanoid_getbyte := (taito_68705_0.port_a_out and taito_68705_0.ddr_a) or (taito_68705_0.port_a_in and not(taito_68705_0.ddr_a));
    1:
      arkanoid_getbyte := taito_68705_0.arkanoid_call;
    2:
      begin
    ...
    $10 .. $7FF:
      arkanoid_getbyte := taito_68705_0.mcu_mem[direccion];
  end;
end;
...
begin
  ...
  case direccion of
    ...
    2:
      begin
        if (((taito_68705_0.ddr_c and 4) <> 0) and ((not(valor) and 4) <> 0) and ((taito_68705_0.port_c_out and 4) <> 0)) then
        begin
        ...
        if (((taito_68705_0.ddr_c and 8) <> 0) and ((not(valor) and 8) <> 0) and ((taito_68705_0.port_c_out and 8) <> 0)) then
        begin
    ...
    4:
      taito_68705_0.ddr_a := valor;
    6:
      taito_68705_0.ddr_c := valor;
    $10 .. $7F:
      taito_68705_0.mcu_mem[direccion] := valor;
    $80 .. $7FF:
      ; // ROM
  end;
end;
...
begin
  ...
  case direccion of
    0:
      getbyte := (taito_68705_0.port_a_out and taito_68705_0.ddr_a) or (taito_68705_0.port_a_in and not(taito_68705_0.ddr_a));
    1:
      getbyte := (taito_68705_0.port_b_out and taito_68705_0.ddr_b) or (taito_68705_0.port_b_in and not(taito_68705_0.ddr_b));
    2:
      begin
    ...
    $10 .. $7FF:
      getbyte := taito_68705_0.mcu_mem[direccion];
  end;
end;
...
begin
  ...
  case direccion of
    0:
      begin
        taito_68705_0.port_a_out := valor;
        if @taito_68705_0.write_addr_0 <> nil then
          taito_68705_0.write_addr_0(valor);
      end;
    1:
      begin
        if (((taito_68705_0.ddr_b and 2) <> 0) and ((not(valor) and 2) <> 0) and ((taito_68705_0.port_b_out and 2) <> 0)) then
        begin
          taito_68705_0.port_a_in := taito_68705_0.from_main;
          if taito_68705_0.main_sent then
          begin
            taito_68705_0.m68705.irq_request(0, CLEAR_LINE);
            taito_68705_0.main_sent := false;
          end;
        end;
        if (((taito_68705_0.ddr_b and 4) <> 0) and ((valor and 4) <> 0) and ((not(taito_68705_0.port_b_out) and 4) <> 0)) then
        begin
          taito_68705_0.from_mcu := taito_68705_0.port_a_out;
          taito_68705_0.mcu_sent := true;
        end;
        if (((taito_68705_0.ddr_b and 8) <> 0) and ((not(valor) and 8) <> 0) and ((taito_68705_0.port_b_out and 8) <> 0)) then
        begin
          if @taito_68705_0.misc_call <> nil then
            taito_68705_0.misc_call(0, taito_68705_0.port_a_out);
        end;
        if (((taito_68705_0.ddr_b and $10) <> 0) and ((not(valor) and $10) <> 0) and ((taito_68705_0.port_b_out and $10) <> 0)) then
        begin
          if @taito_68705_0.misc_call <> nil then
            taito_68705_0.misc_call(1, taito_68705_0.port_a_out);
        end;
...
begin
  ...
  case mcu_type of
    0:
      self.read_addr_2 := read_addr_2_st;
    1:
      begin
