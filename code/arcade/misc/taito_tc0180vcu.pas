...
begin
  case direccion of
    0 .. $13FFF:
      read := self.ram[direccion shr 1];
    $18000 .. $1801F:
      read := self.ctrl[(direccion and $1F) shr 1];
    $40000 .. $7FFFF:
      halt(0); // FUNC(tc0180vcu_device::framebuffer_word_r)
  end;
end;
...
begin
  case direccion of
          ...
          case direccion of
            ...
            7:
              begin
                ...
                if (self.video_control and $80) <> 0 then
                  self.framebuffer_page := (not(self.video_control) and $40) shr 6;
    ...
    $40000 .. $7FFFF:
      halt(0); // FUNC(tc0180vcu_device::framebuffer_word_w));
  end;
end;
...
begin
  ...
  begin
    ...
    for fx := 0 to size_x do
    begin
      for fy := 0 to size_y do
      begin
