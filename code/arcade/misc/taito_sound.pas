...
begin
  case direccion of
    0 .. $3FFF:
      rastan_snd_getbyte := tc0140syt_0.snd_rom[direccion];
    $4000 .. $7FFF:
      rastan_snd_getbyte := tc0140syt_0.snd_bank_rom[tc0140syt_0.sound_bank, direccion and $3FFF];
    $8000 .. $8FFF:
      rastan_snd_getbyte := tc0140syt_0.ram[direccion and $FFF];
    $9001:
      rastan_snd_getbyte := tc0140syt_0.ym2151.status;
    $A001:
...
begin
  case direccion of
    0 .. $7FFF:
      ; // ROM
    $8000 .. $8FFF:
      tc0140syt_0.ram[direccion and $FFF] := valor;
    $9000:
      tc0140syt_0.ym2151.reg(valor);
    $9001:
      tc0140syt_0.ym2151.write(valor);
    $A000:
...
begin
  case direccion of
    0 .. $7FFF:
      volfied_snd_getbyte := tc0140syt_0.snd_rom[direccion];
    $8000 .. $87FF:
      volfied_snd_getbyte := tc0140syt_0.ram[direccion and $7FF];
    $8801:
...
begin
  case direccion of
    0 .. $7FFF:
      ; // ROM
    $8000 .. $87FF:
      tc0140syt_0.ram[direccion and $7FF] := valor;
    $8800:
      tc0140syt_0.slave_port_w(valor);
    $8801:
      tc0140syt_0.slave_comm_w(valor);
...
begin
  case direccion of
    0 .. $3FFF:
      taitob_snd_getbyte := tc0140syt_0.snd_rom[direccion];
    $4000 .. $7FFF:
      taitob_snd_getbyte := tc0140syt_0.snd_bank_rom[tc0140syt_0.sound_bank, direccion and $3FFF];
    $C000 .. $DFFF:
      taitob_snd_getbyte := tc0140syt_0.ram[direccion and $1FFF];
    $E000:
      taitob_snd_getbyte := ym2203_0.status;
    $E001:
      taitob_snd_getbyte := ym2203_0.read;
    $E002 .. $E003:
      taitob_snd_getbyte := 0; // ymadpcm
    $E201:
      taitob_snd_getbyte := tc0140syt_0.slave_comm_r;
  end;
end;
...
begin
  case direccion of
    0 .. $7FFF:
      ; // ROM
    $C000 .. $DFFF:
      tc0140syt_0.ram[direccion and $1FFF] := valor;
    $E000:
      ym2203_0.control(valor);
    $E001:
      ym2203_0.write(valor);
...
begin
  case direccion of
    0 .. $3FFF:
      masterw_snd_getbyte := tc0140syt_0.snd_rom[direccion];
    $4000 .. $7FFF:
      masterw_snd_getbyte := tc0140syt_0.snd_bank_rom[tc0140syt_0.sound_bank, direccion and $3FFF];
    $8000 .. $8FFF:
      masterw_snd_getbyte := tc0140syt_0.ram[direccion and $FFF];
    $9000:
      masterw_snd_getbyte := ym2203_0.status;
    $9001:
      masterw_snd_getbyte := ym2203_0.read;
    $A001:
      masterw_snd_getbyte := tc0140syt_0.slave_comm_r;
  end;
end;
...
begin
  case self.mainmode of
    ...
    $04:
      comm_r := self.status; // port status
  else
    comm_r := 0;
  end;
end;
...
begin
  if (self.nmi_req and self.nmi_enabled) then
  begin
...
begin
  ...
  case self.submode of
    ...
    $04:
      ; // port status
    $05:
      self.nmi_enabled := false; // nmi disable
    $06:
      self.nmi_enabled := true; // nmi enable
  end;
