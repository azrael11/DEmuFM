...
const
  toki_rom: array [0 .. 3] of tipo_roms = ((n: 'l10_6.bin'; l: $20000; p: 0; crc: $94015D91), (n: 'k10_4e.bin'; l: $20000; p: 1; crc: $531BD3EF), (n: 'tokijp.005'; l: $10000; p: $40000; crc: $D6A82808), (n: 'tokijp.003'; l: $10000; p: $40001; crc: $A01A5B10));
  ...
  toki_dip: array [0 .. 9] of def_dip2 = ((mask: $1F; name: 'Coinage'; number: 32; val32: ($15, $17, $19, $1B, 3, $1D, 5, 7, $1F, 9, $13, $11, $F, $D, $B, $1E, $14, $A, 0, 1, 2, 4, 6, 8, $C, $E, $10, $12, $16, $18, $1A, $1C);
    name32: ('6C 1C', '5C 1C', '4C 1C', '3C 1C', '8C 3C', '2C 1C', '5C 3C', '3C 2C', '1C 1C', '2C 3C', '1C 2C', '1C 3C', '1C 4C', '1C 5C', '1C 6C', 'A 1C 1C/B 1/2', 'A 2C 1C/B 1/3', 'A 3C 1C/B 1/5', 'A 5C 1C/B 1/6', 'Free Play', 'Invalid', 'Invalid', 'Invalid', 'Invalid',
    'Invalid', 'Invalid', 'Invalid', 'Invalid', 'Invalid', 'Invalid', 'Invalid', 'Invalid')), (mask: $20; name: 'Joysticks'; number: 2; val2: ($20, 0); name2: ('1', '2')), (mask: $40; name: 'Cabinet'; number: 2; val2: ($40, 0); name2: ('Upright', 'Cocktail')), (mask: $80;
    name: 'Flip Screen'; number: 2; val2: ($80, 0); name2: ('Off', 'On')), (mask: $300; name: 'Lives'; number: 4; val4: ($200, $300, $100, 0); name4: ('2', '3', '5', 'Infinite')), (mask: $C00; name: 'Bonus Life'; number: 4; val4: ($800, 0, $C00, $400);
    name4: ('50K 150K', '70K 140K 210K', '70K', '100K 200K')), (mask: $3000; name: 'Difficulty'; number: 4; val4: ($2000, $3000, $1000, 0); name4: ('Easy', 'Medium', 'Hard', 'Hardest')), (mask: $4000; name: 'Allow Continue'; number: 2; val2: (0, $4000); name2: ('No', 'Yes')),
