...
begin
  case direccion of
    ...
    $2400:
      mikie_getbyte := marcade.in2; // system
    $2401:
      mikie_getbyte := marcade.in0; // p1
    $2402:
      mikie_getbyte := marcade.in1; // p2
    $2403:
      mikie_getbyte := marcade.dswc; // dsw3
    $2500:
      mikie_getbyte := marcade.dswa; // dsw1
    $2501:
      mikie_getbyte := marcade.dswb; // dsw2
  end;
end;
