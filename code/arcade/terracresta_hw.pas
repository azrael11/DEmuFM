...
const
  terracre_rom: array [0 .. 7] of tipo_roms = ((n: '1a_4b.rom'; l: $4000; p: 1; crc: $76F17479), (n: '1a_4d.rom'; l: $4000; p: 0; crc: $8119F06E), (n: '1a_6b.rom'; l: $4000; p: $8001; crc: $BA4B5822), (n: '1a_6d.rom'; l: $4000; p: $8000; crc: $CA4852F6), (n: '1a_7b.rom';
    l: $4000; p: $10001; crc: $D0771BBA), (n: '1a_7d.rom'; l: $4000; p: $10000; crc: $029D59D9), (n: '1a_9b.rom'; l: $4000; p: $18001; crc: $69227B56), (n: '1a_9d.rom'; l: $4000; p: $18000; crc: $5A672942));
  terracre_pal: array [0 .. 4] of tipo_roms = ((n: 'tc1a_10f.bin'; l: $100; p: 0; crc: $CE07C544), (n: 'tc1a_11f.bin'; l: $100; p: $100; crc: $566D323A), (n: 'tc1a_12f.bin'; l: $100; p: $200; crc: $7EA63946), (n: 'tc2a_2g.bin'; l: $100; p: $300; crc: $08609BAD),
  ...
  terracre_sprites: array [0 .. 3] of tipo_roms = ((n: '2a_6e.rom'; l: $4000; p: 0; crc: $BCF7740B), (n: '2a_7e.rom'; l: $4000; p: $4000; crc: $A70B565C), (n: '2a_6g.rom'; l: $4000; p: $8000; crc: $4A9EC3E6), (n: '2a_7g.rom'; l: $4000; p: $C000; crc: $450749FC));
  terracre_dip: array [0 .. 10] of def_dip2 = ((mask: 3; name: 'Lives'; number: 4; val4: (3, 2, 1, 0); name4: ('3', '4', '5', '6')), (mask: $C; name: 'Bonus Life'; number: 4; val4: ($C, 8, 4, 0); name4: ('20K 60K+', '30K 70K+', '40K 80K+', '50K 90K+')), (mask: $10;
    name: 'Demo Sounds'; number: 2; val2: (0, $10); name2: ('Off', 'On')), (mask: $20; name: 'Cabinet'; number: 2; val2: (0, $20); name2: ('Upright', 'Cocktail')), (mask: $300; name: 'Coin A'; number: 4; val4: ($100, $300, $200, 0);
    ...
    name: 'Flip Screen'; number: 2; val2: ($2000, 0); name2: ('Off', 'On')), (mask: $4000; name: 'Complete Invulnerability'; number: 2; val2: ($4000, 0); name2: ('Off', 'On')), (mask: $8000; name: 'Base Ship Invulnerability'; number: 2; val2: ($8000, 0);
    name2: ('Off', 'On')), ());
  // Amazon
  amazon_rom: array [0 .. 3] of tipo_roms = ((n: '11.4d'; l: $8000; p: 0; crc: $6C7F85C5), (n: '9.4b'; l: $8000; p: 1; crc: $E1B7A989), (n: '12.6d'; l: $8000; p: $10000; crc: $4DE8A3EE), (n: '10.6b'; l: $8000; p: $10001; crc: $D86BAD81));
  ...
  amazon_sprites: array [0 .. 3] of tipo_roms = ((n: '4.6e'; l: $4000; p: 0; crc: $F77CED7A), (n: '5.7e'; l: $4000; p: $4000; crc: $16EF1465), (n: '6.6g'; l: $4000; p: $8000; crc: $936EC941), (n: '7.7g'; l: $4000; p: $C000; crc: $66DD718E));
  amazon_pal: array [0 .. 4] of tipo_roms = ((n: 'clr.10f'; l: $100; p: 0; crc: $6440B341), (n: 'clr.11f'; l: $100; p: $100; crc: $271E947F), (n: 'clr.12f'; l: $100; p: $200; crc: $7D38621B), (n: '2g'; l: $100; p: $300; crc: $44CA16B9), (n: '4e'; l: $100; p: $400;
    crc: $035F2C7B));
  amazon_prot: tipo_roms = (n: '16.18g'; l: $2000; p: 0; crc: $1D8D592B);
  amazon_dip: array [0 .. 10] of def_dip2 = ((mask: 3; name: 'Lives'; number: 4; val4: (3, 2, 1, 0); name4: ('3', '4', '5', '6')), (mask: $C; name: 'Bonus Life'; number: 4; val4: ($C, 8, 4, 0); name4: ('20K 40K+', '50K 40K+', '20K 70K+', '50K 70K+')), (mask: $10;
    name: 'Demo Sounds'; number: 2; val2: (0, $10); name2: ('Off', 'On')), (mask: $20; name: 'Cabinet'; number: 2; val2: (0, $20); name2: ('Upright', 'Cocktail')), (mask: $300; name: 'Coin A'; number: 4; val4: ($100, $300, $200, 0);
    name4: ('2C 1C', '1C 1C', '1C 2C', 'Free Play')), (mask: $C00; name: 'Coin B'; number: 4; val4: (0, $800, $400, $C00); name4: ('3C 1C', '1C 1C', '2C 3C', '1C 3C')), (mask: $1000; name: 'Difficulty'; number: 2; val2: ($1000, 0); name2: ('Easy', 'Hard')), (mask: $2000;
    name: 'Flip Screen'; number: 2; val2: ($2000, 0); name2: ('Off', 'On')), (mask: $4000; name: 'Level'; number: 2; val2: ($4000, 0); name2: ('Low', 'High')), (mask: $8000; name: 'Sprite Test'; number: 2; val2: ($8000, 0); name2: ('Off', 'On')), ());
