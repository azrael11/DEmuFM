...
const
  jailbreak_rom: array [0 .. 1] of tipo_roms = ((n: '507p03.11d'; l: $4000; p: $8000;
    crc: $A0B88DFD), (n: '507p02.9d'; l: $4000; p: $C000; crc: $444B7D8E));
  jailbreak_char: array [0 .. 1] of tipo_roms = ((n: '507l08.4f'; l: $4000; p: 0; crc: $E3B7A226),
    (n: '507j09.5f'; l: $4000; p: $4000; crc: $504F0912));
  jailbreak_sprites: array [0 .. 3] of tipo_roms = ((n: '507j04.3e'; l: $4000; p: 0;
    crc: $0D269524), (n: '507j05.4e'; l: $4000; p: $4000; crc: $27D4F6F4), (n: '507j06.5e';
    l: $4000; p: $8000; crc: $717485CB), (n: '507j07.3f'; l: $4000; p: $C000; crc: $E933086F));
  jailbreak_pal: array [0 .. 3] of tipo_roms = ((n: '507j10.1f'; l: $20; p: 0; crc: $F1909605),
    (n: '507j11.2f'; l: $20; p: $20; crc: $F70BB122), (n: '507j13.7f'; l: $100; p: $40;
    crc: $D4FE5C97), (n: '507j12.6f'; l: $100; p: $140; crc: $0266C7DB));
  jailbreak_vlm: tipo_roms = (n: '507l01.8c'; l: $4000; p: $0; crc: $0C8A3605);
  // Dip
  jailbreak_dip_a: array [0 .. 2] of def_dip = ((mask: $0F; name: 'Coin A'; number: 16;
    ...
    dip_name: '1C 7C'), ())), ());
  jailbreak_dip_b: array [0 .. 5] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    ...
    name: 'Bonus Life'; number: 2; dip: ((dip_val: $8; dip_name: '30K 70K+'), (dip_val: $0;
    dip_name: '40K 80K+'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $30;
    name: 'Difficulty'; number: 4; dip: ((dip_val: $30; dip_name: 'Easy'), (dip_val: $20;
    dip_name: 'Normal'), (dip_val: $10; dip_name: 'Difficult'), (dip_val: $0;
    dip_name: 'Very Difficult'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $80;
    name: 'Demo Sounds'; number: 2; dip: ((dip_val: $80; dip_name: 'Off'), (dip_val: $0;
    dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), ());
  jailbreak_dip_c: array [0 .. 2] of def_dip = ((mask: $1; name: 'Flip Screen'; number: 2;
...
begin
  case direccion of
    ...
    $2020 .. $203F:
      begin
        scroll_lineas[direccion and $1F] := (scroll_lineas[direccion and $1F] and $00FF) or
          ((valor and 1) shl 8);
        memory[direccion] := valor;
      end;
    $2042:
