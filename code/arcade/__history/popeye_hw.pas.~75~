...
const
  popeye_rom: array [0 .. 3] of tipo_roms = ((n: 'tpp2-c_f.7a'; l: $2000; p: 0; crc: $9AF7C821),
  ...
  popeye_pal: array [0 .. 3] of tipo_roms = ((n: 'tpp2-c.4a'; l: $20; p: 0; crc: $375E1602), (n: 'tpp2-c.3a';
    l: $20; p: $20; crc: $E950BEA1), (n: 'tpp2-c.5b'; l: $100; p: $40; crc: $C5826883), (n: 'tpp2-c.5a';
    l: $100; p: $140; crc: $C576AFBA));
  popeye_char: tipo_roms = (n: 'tpp2-v.5n'; l: $1000; p: 0; crc: $CCA61DDD);
  popeye_sprites: array [0 .. 3] of tipo_roms = ((n: 'tpp2-v.1e'; l: $2000; p: 0; crc: $0F2CD853),
    (n: 'tpp2-v.1f'; l: $2000; p: $2000; crc: $888F3474), (n: 'tpp2-v.1j'; l: $2000; p: $4000;
    crc: $7E864668), (n: 'tpp2-v.1k'; l: $2000; p: $6000; crc: $49E1D170));
  skyskipper_rom: array [0 .. 6] of tipo_roms = ((n: 'tnx1-c.2a'; l: $1000; p: 0; crc: $BDC7F218),
    (n: 'tnx1-c.2b'; l: $1000; p: $1000; crc: $CBE601A8), (n: 'tnx1-c.2c'; l: $1000; p: $2000;
    crc: $5CA79ABF), (n: 'tnx1-c.2d'; l: $1000; p: $3000; crc: $6B7A7071), (n: 'tnx1-c.2e'; l: $1000;
    p: $4000; crc: $6B0C0525), (n: 'tnx1-c.2f'; l: $1000; p: $5000; crc: $D1712424), (n: 'tnx1-c.2g';
    l: $1000; p: $6000; crc: $8B33C4CF));
  skyskipper_pal: array [0 .. 3] of tipo_roms = ((n: 'tnx1-t.4a'; l: $20; p: 0; crc: $98846924),
  ...
  skyskipper_sprites: array [0 .. 3] of tipo_roms = ((n: 'tnx1-t.1e'; l: $1000; p: 0; crc: $01C1120E),
    (n: 'tnx1-t.2e'; l: $1000; p: $1000; crc: $70292A71), (n: 'tnx1-t.3e'; l: $1000; p: $2000;
    crc: $92B6A0E8), (n: 'tnx1-t.5e'; l: $1000; p: $3000; crc: $CC5F0AC3));
  // Dip
  popeye_dip_a: array [0 .. 2] of def_dip = ((mask: $F; name: 'Coinage'; number: 9;
    dip: ((dip_val: $8; dip_name: '6C 1C'), (dip_val: $5; dip_name: '5C 1C'), (dip_val: $9;
    dip_name: '4C 1C'), (dip_val: $A; dip_name: '3C 1C'), (dip_val: $D; dip_name: '2C 1C'), (dip_val: $F;
    dip_name: '1C 1C'), (dip_val: $E; dip_name: '1C 2C'), (dip_val: $3; dip_name: '1C 3C'), (dip_val: $0;
    dip_name: 'Freeplay'), (), (), (), (), (), (), ())), (mask: $60; name: 'Copyright'; number: 3;
    dip: ((dip_val: $40; dip_name: 'Nintendo'), (dip_val: $20; dip_name: 'Nintendo Co.,Ltd'), (dip_val: $60;
    dip_name: 'Nintendo of America'), (), (), (), (), (), (), (), (), (), (), (), (), ())), ());
  popeye_dip_b: array [0 .. 5] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    dip: ((dip_val: $3; dip_name: '1'), (dip_val: $2; dip_name: '2'), (dip_val: $1;
    dip_name: '3'), (dip_val: $0; dip_name: '4'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $C;
    name: 'Difficulty'; number: 4; dip: ((dip_val: $C; dip_name: 'Easy'), (dip_val: $8;
    dip_name: 'Medium'), (dip_val: $4; dip_name: 'Hard'), (dip_val: $0; dip_name: 'Hardest'), (), (), (), (),
    (), (), (), (), (), (), (), ())), (mask: $30; name: 'Bonus Life'; number: 4;
    dip: ((dip_val: $30; dip_name: '40K'), (dip_val: $20; dip_name: '60K'), (dip_val: $10;
    dip_name: '80K'), (dip_val: $0; dip_name: 'None'), (), (), (), (), (), (), (), (), (), (), (), ())),
    (mask: $40; name: 'Demo Sounds'; number: 2; dip: ((dip_val: $40; dip_name: 'Off'), (dip_val: $0;
    dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $80; name: 'Cabinet';
    number: 2; dip: ((dip_val: $0; dip_name: 'Upright'), (dip_val: $80; dip_name: 'Cocktail'), (), (), (), (),
    (), (), (), (), (), (), (), (), (), ())), ());
  skyskipper_dip_a: array [0 .. 1] of def_dip = ((mask: $F; name: 'Coinage'; number: 9;
    dip: ((dip_val: $3; dip_name: 'A 3/1 B 1/2'), (dip_val: $E; dip_name: '2C 1C'), (dip_val: $1;
    dip_name: 'A 2/1 B 2/5'), (dip_val: $4; dip_name: 'A 2/1 B 1/3'), (dip_val: $7; dip_name: 'A 1/1 B 2/1'),
    (dip_val: $F; dip_name: '1C 1C'), (dip_val: $C; dip_name: 'A 1/1 B 1/2'), (dip_val: $D;
    dip_name: '1C 2C'), (dip_val: $6; dip_name: 'A 1/2 B 1/4'), (dip_val: $B; dip_name: 'A 1/2 B 1/5'),
    (dip_val: $2; dip_name: 'A 2/5 B 1/1'), (dip_val: $A; dip_name: 'A 1/3 B 1/1'), (dip_val: $9;
    dip_name: 'A 1/4 B 1/1'), (dip_val: $5; dip_name: 'A 1/5 B 1/1'), (dip_val: $8; dip_name: 'A 1/6 B 1/1'),
    (dip_val: $0; dip_name: 'Freeplay'))), ());
  skyskipper_dip_b: array [0 .. 5] of def_dip = ((mask: $3; name: 'Lives'; number: 4;
    dip: ((dip_val: $3; dip_name: '1'), (dip_val: $2; dip_name: '2'), (dip_val: $1;
    dip_name: '3'), (dip_val: $0; dip_name: '4'), (), (), (), (), (), (), (), (), (), (), (), ())),
    (mask: $1C; name: 'Difficulty'; number: 8; dip: ((dip_val: $1C; dip_name: 'Easiest'), (dip_val: $18;
    dip_name: 'Very Easy'), (dip_val: $14; dip_name: 'Easy'), (dip_val: $10; dip_name: 'Medium Easy'),
    (dip_val: $C; dip_name: 'Medium Hard'), (dip_val: $8; dip_name: 'Hard'), (dip_val: $4;
    dip_name: 'Very Hard'), (dip_val: $0; dip_name: 'Hardest'), (), (), (), (), (), (), (), ())), (mask: $20;
    name: 'Bonus Life'; number: 2; dip: ((dip_val: $20; dip_name: '15K'), (dip_val: $0;
    dip_name: '30K'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $40; name: 'Service';
...
const
  ...
  ps_y: array [0 .. 15] of dword = (15 * 8, 14 * 8, 13 * 8, 12 * 8, 11 * 8, 10 * 8, 9 * 8, 8 * 8, 7 * 8,
    6 * 8, 5 * 8, 4 * 8, 3 * 8, 2 * 8, 1 * 8, 0 * 8);
  pc_x: array [0 .. 15] of dword = (7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1, 0, 0);
  pc_y: array [0 .. 15] of dword = (0 * 8, 0 * 8, 1 * 8, 1 * 8, 2 * 8, 2 * 8, 3 * 8, 3 * 8, 4 * 8, 4 * 8,
    5 * 8, 5 * 8, 6 * 8, 6 * 8, 7 * 8, 7 * 8);
begin
