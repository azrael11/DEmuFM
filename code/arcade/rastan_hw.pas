...
const
  rastan_rom: array [0 .. 5] of tipo_roms = ((n: 'b04-38.19'; l: $10000; p: 0; crc: $1C91DBB1), (n: 'b04-37.7'; l: $10000; p: $1; crc: $ECF20BDD), (n: 'b04-40.20'; l: $10000; p: $20000; crc: $0930D4B3), (n: 'b04-39.8'; l: $10000; p: $20001; crc: $D95ADE5E), (n: 'b04-42.21';
    l: $10000; p: $40000; crc: $1857A7CB), (n: 'b04-43-1.9'; l: $10000; p: $40001; crc: $CA4702FF));
  rastan_char: array [0 .. 3] of tipo_roms = ((n: 'b04-01.40'; l: $20000; p: 0; crc: $CD30DE19), (n: 'b04-03.39'; l: $20000; p: $20000; crc: $AB67E064), (n: 'b04-02.67'; l: $20000; p: $40000; crc: $54040FEC), (n: 'b04-04.66'; l: $20000; p: $60000; crc: $94737E93));
  rastan_sound: tipo_roms = (n: 'b04-19.49'; l: $10000; p: 0; crc: $EE81FDD8);
  rastan_sprites: array [0 .. 3] of tipo_roms = ((n: 'b04-05.15'; l: $20000; p: 0; crc: $C22D94AC), (n: 'b04-07.14'; l: $20000; p: $20000; crc: $B5632A51), (n: 'b04-06.28'; l: $20000; p: $40000; crc: $002CCF39), (n: 'b04-08.27'; l: $20000; p: $60000; crc: $FEAFCA05));
...
const
  ...
  ps_x: array [0 .. 15] of dword = (0, 4, $40000 * 8 + 0, $40000 * 8 + 4, 8 + 0, 8 + 4, $40000 * 8 + 8 + 0, $40000 * 8 + 8 + 4, 16 + 0, 16 + 4, $40000 * 8 + 16 + 0, $40000 * 8 + 16 + 4, 24 + 0, 24 + 4, $40000 * 8 + 24 + 0, $40000 * 8 + 24 + 4);
...
begin
  ...
  if not(roms_load(@memory_temp, rastan_sound)) then
    exit;
  copymemory(@tc0140syt_0.snd_rom[0], @memory_temp[0], $4000);
