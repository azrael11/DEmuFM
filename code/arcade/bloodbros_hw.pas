...
const
  bloodbros_rom: array [0 .. 3] of tipo_roms = ((n: '2.u021.7n'; l: $20000; p: 1; crc: $204DCA6E), (n: '1.u022.8n'; l: $20000; p: $0; crc: $AC6719E7), (n: '4.u023.7l'; l: $20000; p: $40001;
    crc: $FD951C2C), (n: '3.u024.8l'; l: $20000; p: $40000; crc: $18D3C460));
  bloodbros_sound: tipo_roms = (n: 'bb_07.u1016.6a'; l: $10000; p: 0; crc: $411B94E8);
  bloodbros_char: array [0 .. 1] of tipo_roms = ((n: 'bb_05.u061.6f'; l: $10000; p: 0; crc: $04BA6D19), (n: 'bb_06.u063.6d'; l: $10000; p: $10000; crc: $7092E35B));
  ...
  bloodbros_dip: array [0 .. 7] of def_dip = ((mask: $1E; name: 'Coinage'; number: 16; dip: ((dip_val: $14; dip_name: '6C 1C'), (dip_val: $16; dip_name: '5C 1C'), (dip_val: $18;
    dip_name: '4C 1C'), (dip_val: $1A; dip_name: '3C 1C'), (dip_val: $2; dip_name: '8C 3C'), (dip_val: $1C; dip_name: '2C 1C'), (dip_val: $4; dip_name: '5C 3C'), (dip_val: $6;
    dip_name: '3C 2C'), (dip_val: $1E; dip_name: '1C 1C'), (dip_val: $8; dip_name: '2C 3C'), (dip_val: $12; dip_name: '1C 2C'), (dip_val: $10; dip_name: '1C 3C'), (dip_val: $E;
    dip_name: '1C 4C'), (dip_val: $C; dip_name: '1C 5C'), (dip_val: $A; dip_name: '1C 6C'), (dip_val: $0; dip_name: 'Free Play'))), (mask: $20; name: 'Start Coin'; number: 2;
    dip: ((dip_val: $20; dip_name: 'Normal'), (dip_val: $0; dip_name: 'X2'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $300; name: 'Lives'; number: 4;
    dip: ((dip_val: $0; dip_name: '1'), (dip_val: $200; dip_name: '2'), (dip_val: $300; dip_name: '3'), (dip_val: $100; dip_name: '5'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $C00;
    name: 'Bonus Life'; number: 4; dip: ((dip_val: $C00; dip_name: '300k 500k+'), (dip_val: $800; dip_name: '500k+'), (dip_val: $400; dip_name: '500k'), (dip_val: $0;
    dip_name: 'None'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $3000; name: 'Difficulty'; number: 4;
    dip: ((dip_val: $2000; dip_name: 'Easy'), (dip_val: $3000; dip_name: 'Normal'), (dip_val: $1000; dip_name: 'Hard'), (dip_val: $0; dip_name: 'Very Hard'), (), (), (), (), (), (), (), (), (), (),
  ...
  skysmash_rom: array [0 .. 3] of tipo_roms = ((n: 'rom5'; l: $20000; p: 0; crc: $867F9897), (n: 'rom6'; l: $20000; p: $1; crc: $E9C1D308), (n: 'rom7'; l: $20000; p: $40000; crc: $D209DB4D),
    (n: 'rom8'; l: $20000; p: $40001; crc: $D3646728));
  skysmash_sound: tipo_roms = (n: 'rom2'; l: $10000; p: 0; crc: $75B194CF);
  skysmash_char: array [0 .. 1] of tipo_roms = ((n: 'rom3'; l: $10000; p: 0; crc: $FBB241BE), (n: 'rom4'; l: $10000; p: $10000; crc: $AD3CDE81));
  ...
  skysmash_dip: array [0 .. 7] of def_dip = ((mask: $1E; name: 'Coinage'; number: 16; dip: ((dip_val: $14; dip_name: '6C 1C'), (dip_val: $16; dip_name: '5C 1C'), (dip_val: $18;
    dip_name: '4C 1C'), (dip_val: $1A; dip_name: '3C 1C'), (dip_val: $2; dip_name: '8C 3C'), (dip_val: $1C; dip_name: '2C 1C'), (dip_val: $4; dip_name: '5C 3C'), (dip_val: $6;
    dip_name: '3C 2C'), (dip_val: $1E; dip_name: '1C 1C'), (dip_val: $8; dip_name: '2C 3C'), (dip_val: $12; dip_name: '1C 2C'), (dip_val: $10; dip_name: '1C 3C'), (dip_val: $E;
    dip_name: '1C 4C'), (dip_val: $C; dip_name: '1C 5C'), (dip_val: $A; dip_name: '1C 6C'), (dip_val: $0; dip_name: 'Free Play'))), (mask: $20; name: 'Start Coin'; number: 2;
    dip: ((dip_val: $20; dip_name: 'Normal'), (dip_val: $0; dip_name: 'X2'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $300; name: 'Lives'; number: 4;
    dip: ((dip_val: $200; dip_name: '2'), (dip_val: $300; dip_name: '3'), (dip_val: $100; dip_name: '5'), (dip_val: $0; dip_name: 'Infinite'), (), (), (), (), (), (), (), (), (), (), (), ())),
    (mask: $C00; name: 'Bonus Life'; number: 4; dip: ((dip_val: $C00; dip_name: '120k 200k+'), (dip_val: $800; dip_name: '200k+'), (dip_val: $400; dip_name: '250k+'), (dip_val: $0;
    dip_name: '200k'), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $3000; name: 'Difficulty'; number: 4;
    dip: ((dip_val: $0; dip_name: 'Easy'), (dip_val: $3000; dip_name: 'Normal'), (dip_val: $2000; dip_name: 'Hard'), (dip_val: $1000; dip_name: 'Very Hard'), (), (), (), (), (), (), (), (), (), (),
    (), ())), (mask: $4000; name: 'Allow Continue'; number: 2; dip: ((dip_val: $0; dip_name: 'No'), (dip_val: $4000; dip_name: 'Yes'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())),
    (mask: $8000; name: 'Demo Sounds'; number: 2; dip: ((dip_val: $0; dip_name: 'Off'), (dip_val: $8000; dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), ());
...
const
  ...
  ps_x: array [0 .. 15] of dword = (3, 2, 1, 0, 16 + 3, 16 + 2, 16 + 1, 16 + 0, 3 + 32 * 16, 2 + 32 * 16, 1 + 32 * 16, 0 + 32 * 16, 16 + 3 + 32 * 16, 16 + 2 + 32 * 16, 16 + 1 + 32 * 16,
    16 + 0 + 32 * 16);
