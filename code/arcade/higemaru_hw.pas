...
const
  higemaru_rom: array [0 .. 3] of tipo_roms = ((n: 'hg4.p12'; l: $2000; p: 0; crc: $DC67A7F9),
    (n: 'hg5.m12'; l: $2000; p: $2000; crc: $F65A4B68), (n: 'hg6.p11'; l: $2000; p: $4000;
    crc: $5F5296AA), (n: 'hg7.m11'; l: $2000; p: $6000; crc: $DC5D455D));
  higemaru_pal: array [0 .. 2] of tipo_roms = ((n: 'hgb3.l6'; l: $20; p: 0; crc: $629CEBD8),
    (n: 'hgb5.m4'; l: $100; p: $20; crc: $DBAA4443), (n: 'hgb1.h7'; l: $100; p: $120;
    crc: $07C607CE));
  higemaru_char: tipo_roms = (n: 'hg3.m1'; l: $2000; p: 0; crc: $B37B88C8);
  higemaru_sprites: array [0 .. 1] of tipo_roms = ((n: 'hg1.c14'; l: $2000; p: 0; crc: $EF4C2F5D),
    (n: 'hg2.e14'; l: $2000; p: $2000; crc: $9133F804));
  // Dip
  higemaru_dip_a: array [0 .. 3] of def_dip = ((mask: $7; name: 'Coin A'; number: 8;
    dip: ((dip_val: $1; dip_name: '5C 1C'), (dip_val: $2; dip_name: '4C 1C'), (dip_val: $3;
    dip_name: '3C 1C'), (dip_val: $4; dip_name: '2C 1C'), (dip_val: $7; dip_name: '1C 1C'),
    (dip_val: $6; dip_name: '1C 2C'), (dip_val: $5; dip_name: '1C 5C'), (dip_val: $0;
    dip_name: 'Free Play'), (), (), (), (), (), (), (), ())), (mask: $38; name: 'Coin B'; number: 8;
    dip: ((dip_val: $8; dip_name: '5C 1C'), (dip_val: $10; dip_name: '4C 1C'), (dip_val: $18;
    dip_name: '3C 1C'), (dip_val: $20; dip_name: '2C 1C'), (dip_val: $38;
    ...
    (), (), (), (), (), (), ())), ());
  higemaru_dip_b: array [0 .. 5] of def_dip = ((mask: $1; name: 'Cabinet'; number: 2;
    dip: ((dip_val: $0; dip_name: 'Upright'), (dip_val: $1; dip_name: 'Cocktail'), (), (), (), (),
    (), (), (), (), (), (), (), (), (), ())), (mask: $E; name: 'Bonus Life'; number: 8;
    dip: ((dip_val: $E; dip_name: '10K 50K 50K+'), (dip_val: $C; dip_name: '10K 60K 60K+'),
    (dip_val: $A; dip_name: '20K 60K 60K+'), (dip_val: $8; dip_name: '20K 70K 70K+'), (dip_val: $6;
    dip_name: '30K 70K 70K+'), (dip_val: $4; dip_name: '30K 80K 80K+'), (dip_val: $2;
    dip_name: '40K 100K 100K+'), (dip_val: $0; dip_name: 'None'), (), (), (), (), (), (), (), ())),
    (mask: $10; name: 'Demo Sounds'; number: 2; dip: ((dip_val: $0; dip_name: 'Off'), (dip_val: $10;
    dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $20;
    name: 'Demo Music'; number: 2; dip: ((dip_val: $0; dip_name: 'Off'), (dip_val: $20;
    dip_name: 'On'), (), (), (), (), (), (), (), (), (), (), (), (), (), ())), (mask: $40;
...
gfx[0].trans[15]:=true;
  ...
  begin
    ...
    colores[f].b := 0 + ($47 * ((memory_temp[f] shr 6) and 1)) +
      ($97 * ((memory_temp[f] shr 7) and 1));
  end;
  set_pal(colores, 32);
