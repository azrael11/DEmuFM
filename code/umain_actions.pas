...
begin
  ...
  frm_main.eff_blur_main.Enabled := not frm_main.eff_blur_main.Enabled;
  if frm_main.lay_game.Visible then
  begin
    frm_main.ani_game.StartValue := -1000;
    frm_main.ani_game.StopValue := 50;
  end
  else
  begin
    frm_main.ani_game.StartValue := 50;
    frm_main.ani_game.StopValue := -1000;
  end;
...
begin
  ...
  frm_main.lay_game.Position.Y := -1000;
end;
