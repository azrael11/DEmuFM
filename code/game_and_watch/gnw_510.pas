...
var
  ...
  row, seg, h, y: byte;
begin
  update_region(0, 0, final_x, final_y, 1, 0, 0, final_x, final_y, 2);
  for row := 0 to 3 do
  begin
    for seg := 0 to 15 do
    begin
      for h := 0 to 3 do
      begin
        if (lcd_enabled[row, seg, h] and (lcd_video_data[gnw_video_array[row, seg, h].id] <> nil)) then
        begin
          ...
          update_region(0, 0, gnw_video_array[row, seg, h].size_x, gnw_video_array[row, seg, h].size_y, 3, gnw_video_array[row, seg, h].pos_x + sync_x, gnw_video_array[row, seg, h].pos_y + sync_y,
            gnw_video_array[row, seg, h].size_x, gnw_video_array[row, seg, h].size_y, 2);
        end;
      end;
    end;
  end;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                copymemory(lcd_video_data[gnw_dkongjr_video[row, seg, h].id], dkjr_video[gnw_dkongjr_video[row, seg, h].id], gnw_dkongjr_video[row, seg, h].size_x * gnw_dkongjr_video[row, seg,
                  h].size_y * 2);
              end;
            end;
          end;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                copymemory(lcd_video_data[gnw_dkong2_video[row, seg, h].id], dkong2_video[gnw_dkong2_video[row, seg, h].id], gnw_dkong2_video[row, seg, h].size_x * gnw_dkong2_video[row, seg,
                  h].size_y * 2);
              end;
            end;
          end;
