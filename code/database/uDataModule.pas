...
type
  Tdm = class(TDataModule)
    ...
    tArcadeMedia: TFDTable;
    tArcadeTGDB: TFDTable;
    tArcadeTGDBImages: TFDTable;
    tTGDB: TFDTable;
    tTGDBDevelopers: TFDTable;
    tTGDBbox_art_original: TWideMemoField;
    tTGDBbox_art_small: TWideMemoField;
    tTGDBbox_art_thumb: TWideMemoField;
    tTGDBbox_art_cropped: TWideMemoField;
    tTGDBbox_art_medium: TWideMemoField;
    tTGDBbox_art_large: TWideMemoField;
    tTGDBfanart: TWideMemoField;
    tTGDBboxart: TWideMemoField;
    tTGDBbanner: TWideMemoField;
    tTGDBscreenshot: TWideMemoField;
    tTGDBclearlogo: TWideMemoField;
    tTGDBtitlescreen: TWideMemoField;
    tTGDBremain_monthly_allowance: TIntegerField;
    tTGDBextra_allowance: TIntegerField;
    tTGDBallowance_refresh_timer: TIntegerField;
    ...
    tArcadeMedianum: TFDAutoIncField;
    tArcadeMediarom: TWideMemoField;
    tArcadeMediabox_art: TWideMemoField;
    tArcadeMediasnapshots: TWideMemoField;
    tArcadeMediamanuals: TWideMemoField;
    tArcadeMediavideos: TWideMemoField;
    tArcadeTGDBnum: TFDAutoIncField;
    ...
    tArcadeTGDBImagesgame_id: TIntegerField;
    ...
    tTGDBPublishersnum: TFDAutoIncField;
    ...
    tArcadeConfigbezels_path: TWideMemoField;
...
begin
  ...
  tArcadeMedia.IndexFieldNames := 'rom';
