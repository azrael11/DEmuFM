...
type
  Tdm = class(TDataModule)
    ...
    tKeyboardFrontendquit_DEmuFM: TIntegerField;
    tKeyboardFrontendplay: TIntegerField;
    tKeyboardFrontendmove_up: TIntegerField;
    tKeyboardFrontendmove_down: TIntegerField;
    tKeyboardFrontendmove_left: TIntegerField;
    tKeyboardFrontendmove_right: TIntegerField;
    tKeyboardFrontendshow_configuration: TIntegerField;
    tKeyboardFrontendshow_display: TIntegerField;
    tKeyboardFrontendshow_controls: TIntegerField;
    tKeyboardFrontendshow_information: TIntegerField;
    tKeyboardFrontendshow_hide_time_game: TIntegerField;
    tKeyboardFrontendshow_choose_platform: TIntegerField;
