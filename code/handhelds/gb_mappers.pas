...
begin
  ...
  copymemory(@memory[$0], @self.rom_bank[0, 0], $4000);
  copymemory(@memory[$4000], @self.rom_bank[1, 0], $4000);
  ...
  case self.mapper of
    ...
    $B .. $D:
      begin
        copymemory(@memory[$0], @self.rom_bank[self.rom_size - 2, 0], $4000);
        copymemory(@memory[$4000], @self.rom_bank[self.rom_size - 1, 0], $4000);
      end;
    $C1:
...
begin
  ...
  begin
    copymemory(@memory[$4000], @gb_mapper_0.rom_bank[tempb mod gb_mapper_0.rom_size, 0], $4000);
  ...
  begin
    copymemory(@memory[0], @gb_mapper_0.rom_bank[tempb, 0], $4000);
...
begin
  ...
  copymemory(@memory[$4000], @gb_mapper_0.rom_bank[gb_mapper_0.rom_nbank mod gb_mapper_0.rom_size, 0], $4000);
end;
...
begin
  ...
  begin
    copymemory(@memory[$4000], @gb_mapper_0.rom_bank[tempw mod gb_mapper_0.rom_size, 0], $4000);
...
begin
  ...
  if gb_mapper_0.rom_nbank <> tempb then
  begin
    copymemory(@memory[$4000], @gb_mapper_0.rom_bank[(tempb shr 1) mod gb_mapper_0.rom_size, $2000 * (tempb and 1)], $2000);
    gb_mapper_0.rom_nbank := tempb;
  end;
  if gb_mapper_0.rom_nbank2 <> tempb2 then
  begin
    copymemory(@memory[$6000], @gb_mapper_0.rom_bank[(tempb2 shr 1) mod gb_mapper_0.rom_size, $2000 * (tempb2 and 1)], $2000);
...
begin
  ...
  copymemory(@memory[$0], @gb_mapper_0.rom_bank[(tempb and $1FE) mod gb_mapper_0.rom_size, 0], $4000);
  copymemory(@memory[$4000], @gb_mapper_0.rom_bank[(tempb or 1) mod gb_mapper_0.rom_size, 0], $4000);
end;
...
begin
  ...
  begin
    ...
    copymemory(@memory[$0], @gb_mapper_0.rom_bank[(tempb and $E) mod gb_mapper_0.rom_size, 0], $4000);
    copymemory(@memory[$4000], @gb_mapper_0.rom_bank[(tempb or 1) mod gb_mapper_0.rom_size, 0], $4000);
