...
if rom_nbank<>tempb then begin
   copymemory(@memory[$4000],@rom_bank[tempb mod gb_head.cart_size,0],$4000);
   rom_nbank:=tempb;
end;
...
if tempb<>rom_nbank2 then begin
   copymemory(@memory[0],@rom_bank[tempb,0],$4000);
   rom_nbank2:=tempb;
end;
end;
...
copymemory(@memory[$4000],@rom_bank[rom_nbank mod gb_head.cart_size,0],$4000);
end;
...
if rom_nbank<>tempw then begin
   copymemory(@memory[$4000],@rom_bank[tempw mod gb_head.cart_size,0],$4000);
   rom_nbank:=tempw;
end;
end;
...
copymemory(@memory[$0],@rom_bank[0,0],$4000);
copymemory(@memory[$4000],@rom_bank[1,0],$4000);
map_enable:=false;
ram_enable:=false;
rom_mode:=false;
rom_nbank:=1;
