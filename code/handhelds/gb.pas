...
const
  color_pal: array [0 .. 1, 0 .. 3] of tcolor = (((r: $9B; g: $BC; b: $0F), (r: $8B; g: $AC;
    b: $0F), (r: $30; g: $62; b: $30), (r: $0F; g: $38; b: $0F)), ((r: $FF; g: $FF;
    b: $FF), (r: $AA; g: $AA; b: $AA), (r: $55; g: $55; b: $55), (r: 0; g: 0; b: 0)));
  gb_rom: tipo_roms = (n: 'dmg_boot.bin'; l: $100; p: 0; crc: $59C8598E);
  gbc_rom: array [0 .. 1] of tipo_roms = ((n: 'gbc_boot.1'; l: $100; p: 0; crc: $779EA374),
    ...
    begin
      ...
      case prio of
        0:
          begin
            ptemp^ := paleta[pval];
            bg_prio[(f * 8 + (7 - x) - (256 - scroll_x) + window_x - 7) and $FF] :=
              bg_prio[(f * 8 + (7 - x) - (256 - scroll_x) + window_x - 7) and $FF] or 2;
          end;
        1:
          if (pval = 0) then
          begin
...
begin
  ...
  begin
    ...
    if (((lcd_control and 2) <> 0) and not(oam_dma)) then
      draw_sprites(0);
    if (not((linea_actual < window_y) or (window_x > 166) or (window_x = 0)) and
      ((lcd_control and $20) <> 0)) then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          bg_prio[(f * 8 + x + (256 - scroll_x)) and $FF] :=
            bg_prio[f * 8 + x + (256 - scroll_x)] or 4;
    ...
    begin // Flipx
      ...
      begin
        ...
        if (((atrib and $80) <> 0) and (pval <> 0)) then
        begin
          bg_prio[(f * 8 + (7 - x) + (256 - scroll_x)) and $FF] :=
            bg_prio[f * 8 + (7 - x) + (256 - scroll_x)] or 4;
          ptemp^ := paleta[bgc_pal[pval + tile_pal] and $7FFF];
        end
        else
        begin
      ...
      begin
        ...
        case prio of
          0:
            begin
              ptemp^ := paleta[bgc_pal[pval + tile_pal] and $7FFF];
              bg_prio[(f * 8 + x - (256 - scroll_x) + window_x - 7) and $FF] :=
                bg_prio[(f * 8 + x - (256 - scroll_x) + window_x - 7) and $FF] or 2;
            end;
          1:
            if (pval = 0) then
            begin
    ...
    $55:
      ...
      begin
        ...
        begin
          valor := valor + 1;
          dma_trans(valor * $10);
          lr35902_0.estados_demas := lr35902_0.estados_demas + (220 shr lr35902_0.speed) +
            (8 * valor);
        end;
      end;
    $56:
...
begin
  ...
  case lr35902_0.contador of
    ...
    252 .. 600:
      if ((linea_actual < 144) and ((sprites_time + 252) >= lr35902_0.contador) and
        ((stat and 3) <> 0)) then
      begin // Modo 0
...
procedure abrir_gb;
const
  main_logo: array [0 .. $2F] of byte = ($CE, $ED, $66, $66, $CC, $0D, $00, $0B, $03, $73, $00, $83,
    $00, $0C, $00, $0D, $00, $08, $11, $1F, $88, $89, $00, $0E, $DC, $CC, $6E, $E6, $DD, $DD, $D9,
    $99, $BB, $BB, $67, $63, $6E, $0E, $EC, $CC, $DD, $DC, $99, $9F, $BB, $B9, $33, $3E);
var
  unlicensed: boolean;
