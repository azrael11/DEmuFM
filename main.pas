...
type
  Tfrm_main = class(TForm)
    ...
    edtInfoCoop: TEdit;
    edtInfoYear: TEdit;
    edtInfoDeveloper: TEdit;
    spbInfoDeveloper: TSpeedButton;
    imgInfoDeveloper: TImage;
    ...
    procedure dt_grid_infoDragOver(Sender: TObject; const Data: TDragObject; const Point: TPointF;
    ...
    procedure vsb_gridViewportPositionChange(Sender: TObject;
...
procedure Tfrm_main.dt_grid_infoDragOver(Sender: TObject; const Data: TDragObject; const Point: TPointF;
  var Operation: TDragOperation);
begin
...
procedure Tfrm_main.vsb_gridViewportPositionChange(Sender: TObject;
  const OldViewportPosition, NewViewportPosition: TPointF; const ContentSizeChanged: Boolean);
begin
